...
AmCharts.IEversion = 0; - 1 != navigator.appVersion.indexOf("MSIE") && document
  .documentMode && (AmCharts.IEversion = Number(document.documentMode));
...
AmCharts.clear = function() {
  ...
  AmCharts.isNN && (document.removeEventListener("mousemove", AmCharts.handleMouseMove, !
      0),
...
AmCharts.AmChart = AmCharts.Class({
  ...
  drawBackground: function() {
    ...
    this.realHeight = f;
    this.background = b = AmCharts.polygon(a, [0, e - 1, e - 1, 0], [0, 0,
      f - 1, f - 1
  ...
  initChart: function() {
    ...
    b && window.getComputedStyle && (b = window.getComputedStyle(b, null)) &&
    ...
    this.mouseMode = a;
    this.container = new AmCharts.AmDraw(this.chartDiv, this.realWidth,
      this.realHeight);
  ...
  measure: function() {
    ...
    f = a.style;
    a = f.width;
    f = f.height; - 1 != a.indexOf("px") && (c = AmCharts.removePx(a)); -
  ...
  clear: function(a) {
    AmCharts.callMethod("clear", [this.chartScrollbar, this.scrollbarV,
      this.scrollbarH, this.chartCursor
    ]);
    this.chartCursor = this.scrollbarH = this.scrollbarV = this.chartScrollbar =
      null;
    this.clearTimeOuts();
  ...
  drawLabel: function(a) {
    if (this.container) {
      ...
      "right" == d && (d = "end");
      "center" == d && (d = "middle",
        g ? b = this.realHeight - b + b / 2 : l = this.realWidth / 2 -
        l);
      void 0 === h && (h = 1);
      void 0 === g && (g = 0);
      b += e / 2;
  ...
  validateData: function(a) {
    this.chartCreated && (this.dataChanged = !0,
      this.marginsUpdated = "xy" != this.chartType ? !1 : !0,
      this.initChart(a))
  },
      ...
      if (a) {
        ...
        switch (this.mouseMode) {
          case 1:
            ...
            break;
          case 0:
            this.divIsFixed ? (c = a.clientX - this.posX,
              d = a.clientY - this.posY) : (c = a.pageX - this.posX,
              d = a.pageY - this.posY)
        }
        a.touches && (a = a.touches.item(0),
          c = a.pageX - this.posX,
...
AmCharts.getStyle = function(a, b) {
  var c = "";
  document.defaultView && document.defaultView.getComputedStyle ? c =
    document.defaultView.getComputedStyle(a, "").getPropertyValue(b) : a.currentStyle &&
...
AmCharts.toCoordinate = function(a, b, c) {
  ...
  void 0 !== a && (a = String(a),
    c && c < b && (b = c),
    d = Number(a), -1 != a.indexOf("!") && (d = b - Number(a.substr(1))), -
...
AmCharts.resetDateToMin = function(a, b, c, d) {
  void 0 === d && (d = 1);
  var e, f, g, h, k, l, m;
  AmCharts.useUTC ? (e = a.getUTCFullYear(),
    f = a.getUTCMonth(),
    g = a.getUTCDate(),
    h = a.getUTCHours(),
    k = a.getUTCMinutes(),
  ...
  AmCharts.useUTC ? (a = new Date,
    a.setUTCFullYear(e, f, g),
    a.setUTCHours(h, k, l, m)) : a = new Date(e, f, g, h, k, l, m);
  return a
};
...
AmCharts.formatDuration = function(a, b, c, d, e, f) {
  ...
  if (a >= g[b].contains) {
    ...
    "ss" == b && (k = AmCharts.formatNumber(k, f),
      1 == k.split(h)[0].length && (k = "0" + k));
  ...
  "ss" == b && (a = AmCharts.formatNumber(a, f),
...
AmCharts.formatNumber = function(a, b, c, d, e) {
  ...
  if (k)
    ...
    for (m = k.length; 0 <= m; m -= 3)
      l = m != k.length ? 0 !== m ? k.substring(m - 3, m) + b + l : k.substring(
        m - 3, m) + l : k.substring(m - 3, m);
...
AmCharts.addZeroes = function(a, b, c) {
  ...
  return a[1].length < c ? (a[1] += "0",
      AmCharts.addZeroes(a[0] + b + a[1], b, c)) : void 0 !== a[1] ? a[0] + b +
    a[1] : a[0]
};
...
AmCharts.isInRectangle = function(a, b, c) {
  return a >= c.x - 5 && a <= c.x + c.width + 5 && b >= c.y - 5 && b <= c.y +
    c.height + 5 ? !0 : !1
};
...
AmCharts.formatDate = function(a, b) {
  ...
  AmCharts.useUTC ? (c = a.getUTCFullYear(),
    d = a.getUTCMonth(),
    e = a.getUTCDate(),
    f = a.getUTCDay(),
    g = a.getUTCHours(),
    h = a.getUTCMinutes(),
    k = a.getUTCSeconds(),
    l = a.getUTCMilliseconds()) : (c = a.getFullYear(),
    d = a.getMonth(),
    e = a.getDate(),
    f = a.getDay(),
    g = a.getHours(),
...
AmCharts.findIfAuto = function(a) {
  return a.style && "auto" == AmCharts.getStyle(a, "overflow") ? !0 : a.parentNode ?
    AmCharts.findIfAuto(a.parentNode) : !1
};
...
AmCharts.formatValue = function(a, b, c, d, e, f, g, h) {
  if (b) {
    ...
    for (k = 0; k < c.length; k++) {
      var l = c[k],
        m = b[l];
      void 0 !== m && (m = f ? AmCharts.addPrefix(m, h, g, d) : AmCharts.formatNumber(
          m, d),
        a = a.replace(RegExp("\\[\\[" + e + "" + l + "\\]\\]", "g"), m))
    }
  }
  return a
};
AmCharts.formatDataContextValue = function(a, b) {
  if (a) {
    ...
    for (d = 0; d < c.length; d++) {
      ...
      void 0 !== b[e] && (a = a.replace(RegExp("\\[\\[" + e + "\\]\\]", "g"),
        b[e]))
    }
  }
  return a
...
AmCharts.addPrefix = function(a, b, c, d, e) {
  ...
  if (1 < a)
    for (h = b.length - 1; - 1 < h; h--) {
      if (a >= b[h].number && (k = a / b[h].number,
...
AmCharts.copyProperties = function(a, b) {
  for (var c in a)
    a.hasOwnProperty(c) && "events" != c && (void 0 !== a[c] && "function" !=
      typeof a[c]) && (b[c] = a[c])
};
    ...
    if (0 != b)
      if ("[object Array]" === Object.prototype.toString.call(a))
        for (var c = 0; c < a.length; c++)
          AmCharts.deleteObject(a[c], b - 1),
          a[c] = null;
      else
        try {
          for (c in a)
            a[c] && ("object" == typeof a[c] && AmCharts.deleteObject(a[c], b -
                1),
...
AmCharts.Bezier = AmCharts.Class({
  construct: function(a, b, c, d, e, f, g, h, k, l) {
    ...
    1 < e.length && (b = this.interpolate(e),
      d += this.drawBeziers(b));
  ...
  drawBeziers: function(a) {
    ...
    for (c = 0; c < (a.length - 1) / 3; c++)
      b += this.drawBezierMidpoint(a[3 * c], a[3 * c + 1], a[3 * c + 2],
        a[3 * c + 3]);
    return b
  },
...
AmCharts.Cuboid = AmCharts.Class({
  ...
  draw: function() {
    ...
    var b = this.container,
      ...
      n = g,
      s = g;
    "object" == typeof g && (n = g[0],
      s = g[g.length - 1]);
    var q, v, u, t, w, y, x, A, z;
    if (0 < e || 0 < f)
      x = s,
      s = AmCharts.adjustLuminosity(n, -0.2),
      s = AmCharts.adjustLuminosity(n, -0.2),
      q = AmCharts.polygon(b, [0, e, c + e, c, 0], [0, f, f, 0, 0], s, h,
        0, 0, 0, p),
      0 < m && (z = AmCharts.line(b, [0, e, c + e], [0, f, f], l, m, k)),
      v = AmCharts.polygon(b, [0, 0, c, c, 0], [0, d, d, 0, 0], s, h, 0,
        0, 0, 0, p),
      v.translate(e, f),
      0 < m && (u = AmCharts.line(b, [e, e], [f, f + d], l, 1, k)),
      t = AmCharts.polygon(b, [0, 0, e, e, 0], [0, d, d + f, f, 0], s, h,
        0, 0, 0, p),
      w = AmCharts.polygon(b, [c, c, c + e, c + e, c], [0, d, d + f, f, 0],
        s, h, 0, 0, 0, p),
      0 < m && (y = AmCharts.line(b, [c, c + e, c + e, c], [0, f, d + f,
        d
      ], l, m, k)),
      s = AmCharts.adjustLuminosity(x, 0.2),
      x = AmCharts.polygon(b, [0, e, c + e, c, 0], [d, d + f, d + f, d, d],
        s, h, 0, 0, 0, p),
      0 < m && (A = AmCharts.line(b, [0, e, c + e], [d, d + f, d + f], l,
        m, k));
    1 > Math.abs(d) && (d = 0);
    1 > Math.abs(c) && (c = 0);
    b = 0 === d ? AmCharts.line(b, [0, c], [0, 0], l, m, k) : 0 === c ?
      AmCharts.line(b, [0, 0], [0, d], l, m, k) : 0 < r ? AmCharts.rect(b,
        c, d, g, h, k, l, m, r, p) : AmCharts.polygon(b, [0, 0, c, c, 0], [
        0, d, d, 0, 0
      ], g, h, k, l, m, p);
    d = 0 > d ? [q, z, v, u, t, w, y, x, A, b] : [x, A, v, u, t, w, q, z,
      y, b
    ];
...
AmCharts.AmLegend = AmCharts.Class({
  construct: function() {
    this.createEvents("rollOverMarker", "rollOverItem", "rollOutMarker",
      "rollOutItem", "showItem", "hideItem", "clickMarker",
      "rollOverItem", "rollOutItem", "clickLabel");
  ...
  drawLegend: function() {
    ...
    "outside" == b ? (c = f.offsetWidth,
      ...
      f.clientHeight && (c = f.clientWidth,
        e = f.clientHeight)) : (f.style.width = c + "px",
    ...
    this.titleWidth = 0;
    if (b = this.title)
      a = AmCharts.text(this.container, b, this.color, a.fontFamily, this
        .fontSize, "start", !0),
      a.translate(this.marginLeft, this.marginTop + this.verticalGap +
        this.ly + 1),
      a = a.getBBox(),
  ...
  arrangeEntries: function() {
    ...
    for (t = 0; t < v.length; t++) {
      ...
      u = A.getBBox();
      var z;
      this.equalWidths ? z = f + y * (r + m + this.markerLabelGap) : (z =
        x,
        x = x + u.width + f + m);
      z + u.width > p && (0 < t && 0 != y) && (w++,
        y = 0,
        z = f,
        x = z + u.width + f + m,
        skipNewRow = !0);
    ...
    u = s.getBBox();
    k = u.height + 2 * l - 1;
    "left" == a || "right" == a ? (h = u.width + 2 * f,
      g.style.width = h + b + c + "px") : h = h - b - c - 1;
    c = AmCharts.polygon(this.container, [0, h, h, 0], [0, 0, k, k], this
      .backgroundColor, this.backgroundAlpha, 1, this.borderColor, this
      .borderAlpha);
    q.push(c);
    q.translate(b, d);
    c.toBack();
    ...
    if ("top" == a || "bottom" == a || "absolute" == a || "outside" == a)
      "center" == this.align ? b = f + (h - u.width) / 2 : "right" ==
      this.align && (b = f + h - u.width);
    s.translate(b, l + 1);
  ...
  createEntry: function(a) {
    if (!1 !== a.visibleInLegend) {
      ...
      g = this.color;
      a.showBalloon && (this.textClickEnabled && void 0 !== this.selectedColor) &&
        (g = this.selectedColor);
      ...
      var p;
      d && (d = AmCharts.fixNewLines(d),
        p = AmCharts.text(this.container, d, g, b.fontFamily, k,
          "start"),
        p.translate(this.lx, this.ly),
        e.push(p),
        b = p.getBBox().width,
  ...
  clickMarker: function(a) {
    this.switchable ? !0 === a.hidden ? this.dispatch("showItem", a) :
      this.dispatch("hideItem", a) : this.textClickEnabled && this.dispatch(
        "clickMarker", a)
  },
  ...
  clickLabel: function(a) {
    this.textClickEnabled ? a.hidden || this.dispatch("clickLabel", a) :
      this.switchable && (!0 === a.hidden ? this.dispatch("showItem", a) :
        this.dispatch("hideItem", a))
  },
  ...
  createV: function() {
    ...
    return AmCharts.polygon(this.container, [a / 5, a / 2, a - a / 5, a /
      2
    ], [a / 3, a - a / 5, a / 5, a / 1.7], this.switchColor)
  },
  createX: function() {
  ...
  createMarker: function(a, b, c) {
    ...
    switch (a) {
      ...
      case "dashedLine":
        ...
        break;
      case "triangleUp":
        f = AmCharts.polygon(e, [0, d / 2, d, d], [d, 0, d, d], b, c, h,
          g, k);
        break;
      case "triangleDown":
        f = AmCharts.polygon(e, [0, d / 2, d, d], [0, d, 0, 0], b, c, h,
          g, k);
        break;
      case "bubble":
        f = AmCharts.circle(e, d / 2, b, c, h, g, k, !0),
          f.translate(d / 2, d / 2)
    }
    return f
  },
  ...
  updateValues: function() {
    ...
    for (c = 0; c < a.length; c++) {
      ...
      if (void 0 !== e.type) {
        ...
        f = b.formatString(this.valueText, e),
        d.text(f)
    }
  },
  renderFix: function() {
  ...
  draw: function() {
    ...
    if (!isNaN(a)) {
      ...
      if (this.show) {
        ...
        d = AmCharts.text(e, this.text, this.color, t, w, c);
        f.push(d);
        var y;
        void 0 != m && (y = AmCharts.text(e, this.text, m, t, w, c, !1,
            0.4),
          f.push(y));
        t = d.getBBox();
        m = t.height + 2 * p;
        ...
        "H" != v ? (x = a - t / 2,
          c = b < h + m + 10 && "down" != v ? b + q : b - m - q) : (2 *
          q > m && (q = m / 2),
          c = b - m / 2,
          x = a < g + (k - g) / 2 ? a + q : a - t - q);
        c + m >= l && (c = l - m);
        c < h && (c = h);
        x < g && (x = g);
        x + t > k && (x = k - t);
        0 < u || 0 === q ? (n = AmCharts.rect(e, t, m, r, this.fillAlpha,
            this.borderThickness, n, this.borderAlpha, this.cornerRadius
          ),
          this.showBullet && (e = AmCharts.circle(e, this.bulletSize, r,
              this.fillAlpha),
            e.translate(a, b),
            this.pointer = e)) : (l = [],
          u = [],
          "H" != v ? (g = a - x,
            g > t - q && (g = t - q),
            g < q && (g = q),
            l = [0, g - q, a - x, g + q, t, t, 0, 0],
            u = b < h + m + 10 && "down" != v ? [0, 0, b - c, 0, 0, m,
              m, 0
            ] : [m, m, b - c, m, m, 0, 0, m]) : (h = b - c,
            h > m - q && (h = m - q),
            h < q && (h = q),
            u = [0, h - q, b - c, h + q, m, m, 0, 0],
            l = a < g + (k - g) / 2 ? [0, 0, x < a ? 0 : a - x, 0, 0, t,
              t, 0
            ] : [t, t, x + t > a ? t : a - x, t, t, 0, 0, t]),
          n = AmCharts.polygon(e, l, u, r, this.fillAlpha, this.borderThickness,
            n, this.borderAlpha));
        f.push(n);
        n.toFront();
        y && y.toFront();
...
AmCharts.AmCoordinateChart = AmCharts.Class({
  ...
  construct: function() {
    ...
    this.createEvents("rollOverGraphItem", "rollOutGraphItem",
      "clickGraphItem", "doubleClickGraphItem", "rightClickGraphItem",
      "clickGraph");
  ...
  parseSerialData: function() {
    ...
    if (e) {
      ...
      for (r = 0; r < e.length; r++) {
        ...
        n.category = g ? g(b, s, h) : String(b);
        k && (n.forceShow = s[k]);
        p[s[d]] = n;
        f && (b = h.categoryFunction ? h.categoryFunction(b, s, h) : b instanceof Date ?
          "fff" == h.minPeriod ? AmCharts.useUTC ? new Date(b.getUTCFullYear(),
            b.getUTCMonth(), b.getUTCDate(), b.getUTCHours(), b.getUTCMinutes(),
            b.getUTCSeconds(), b.getUTCMilliseconds()) : new Date(b.getFullYear(),
            b.getMonth(), b.getDate(), b.getHours(), b.getMinutes(), b.getSeconds(),
            b.getMilliseconds()) : new Date(b) : new Date(b),
          b = AmCharts.resetDateToMin(b, l, m),
          n.category = b,
          n.time = b.getTime());
        ...
        for (v = 0; v < q.length; v++) {
          ...
          for (t = 0; t < a.length; t++) {
            ...
            if (b.valueAxis.id == u) {
              ...
              var A = s;
              b.dataProvider && (A = c);
              x.values = this.processValues(A, b, y);
              this.processFields(b, x, A);
  ...
  formatString: function(a, b) {
    var c = b.graph,
      d = c.valueAxis;
    d.duration && b.values.value && (d = AmCharts.formatDuration(b.values
        .value, d.duration, "", d.durationUnits, d.maxInterval, d.numberFormatter
      ),
  ...
  processFields: function(a, b, c) {
    ...
    d =
      "lineColor color alpha fillColors description bullet customBullet bulletSize bulletConfig url labelColor"
      .split(" ");
    for (e = 0; e < d.length; e++) {
      var f = d[e],
        g = a[f + "Field"];
      g && (g = c[g],
        AmCharts.isDefined(g) && (b[f] = g))
    }
    b.dataContext = c
  },
...
AmCharts.AmRectangularChart = AmCharts.Class({
  ...
  construct: function() {
    ...
    this.marginRight = this.marginBottom = this.marginTop = this.marginLeft =
      20;
    this.verticalPosition = this.horizontalPosition = this.depth3D = this
      .angle = 0;
    this.heightMultiplier = this.widthMultiplier = 1;
    this.zoomOutText = "Reset";
    this.zoomOutButton = {
  ...
  resetMargins: function() {
    ...
    if ("serial" == this.chartType) {
      ...
      for (b = 0; b < c.length; b++) {
        var d = c[b];
        d.ignoreAxisWidth || (d.setOrientation(this.rotate),
          d.fixAxisPosition(),
          a[d.position] = !0)
      }
      (b = this.categoryAxis) && !b.ignoreAxisWidth && (b.setOrientation(!
          this.rotate),
        b.fixAxisPosition(),
        b.fixAxisPosition(),
        a[b.position] = !0)
      ...
      for (b = 0; b < d.length; b++) {
        var e = d[b];
        e.ignoreAxisWidth || (e.setOrientation(!0),
          e.fixAxisPosition(),
          a[e.position] = !0)
      }
      for (b = 0; b < c.length; b++)
        d = c[b],
        d.ignoreAxisWidth || (d.setOrientation(!1),
          d.fixAxisPosition(),
          a[d.position] = !0)
    }
  ...
  measureMargins: function() {
    ...
    for (l = 0; l < a.length; l++)
      b = this.getAxisBounds(a[l], g, k, h, b),
      g = b.l,
      k = b.r,
      h = b.t,
      b = b.b;
    if (a = this.categoryAxis)
      b = this.getAxisBounds(a, g, k, h, b),
      g = b.l,
      k = b.r,
      h = b.t,
      b = b.b;
    ...
    d.top && h < c + this.titleHeight && (this.marginTop = Math.round(
      this.marginTop - h + c + this.titleHeight));
  ...
  drawZoomOutButton: function() {
    ...
    var c = a.color,
      d = a.fontSize,
      e = a.zoomOutButton;
    e && (e.fontSize && (d = e.fontSize),
      e.color && (c = e.color));
    c = AmCharts.text(a.container, a.zoomOutText, c, a.fontFamily, d,
      "start");
    d = c.getBBox();
    c.translate(29, 6 + d.height / 2);
    e = AmCharts.rect(a.container, d.width + 40, d.height + 15, e.backgroundColor,
      e.backgroundAlpha);
    b.push(e);
    a.zbBG = e;
    void 0 !== a.pathToImages && (e = a.container.image(a.pathToImages +
        "lens.png", 0, 0, 16, 16),
      e.translate(7, d.height / 2 - 1),
      e.toFront(),
      b.push(e));
    c.toFront();
    b.push(c);
  ...
  drawPlotArea: function() {
    ...
    "object" == typeof h && (h = h[0]);
    g = AmCharts.polygon(this.container, [0, e, e, 0], [0, 0, f, f], g, h,
      1, k, l, this.plotAreaGradientAngle);
    g.translate(c + a, d + b);
    g.node.setAttribute("class", "amChartsPlotArea");
    this.set.push(g);
    0 !== a && 0 !== b && (g = this.plotAreaFillColors,
      "object" == typeof g && (g = g[0]),
      g = AmCharts.adjustLuminosity(g, -0.15),
      e = AmCharts.polygon(this.container, [0, a, e + a, e, 0], [0, b,
        b, 0, 0
      ], g, h, 1, k, l),
      e.translate(c, d + f),
      this.set.push(e),
      a = AmCharts.polygon(this.container, [0, 0, a, a, 0], [0, f, f +
        b, b, 0
      ], g, h, 1, k, l),
      a.translate(c, d),
      this.set.push(a))
  ...
  updateDxy: function() {
    ...
    this.dy = Math.round(-this.depth3D * Math.sin(this.angle * Math.PI /
      180));
    this.d3x = Math.round(this.columnSpacing3D * Math.cos(this.angle *
      Math.PI / 180));
  ...
  zoomTrendLines: function() {
    ...
    for (b = 0; b < a.length; b++) {
      var c = a[b];
      c.valueAxis.recalculateToPercents ? c.set && c.set.hide() : (c.x =
        this.marginLeftReal + this.horizontalPosition,
        c.y = this.marginTopReal + this.verticalPosition,
        c.draw())
    }
  },
  ...
  adjustMargins: function(a, b) {
    ...
    "top" == a.position ? b ? this.marginLeftReal += c : this.marginTopReal +=
      c : b ? this.marginRightReal += c : this.marginBottomReal += c
  },
  getScrollbarPosition: function(a, b, c) {
    a.position = b ? "bottom" == c || "left" == c ? "bottom" : "top" :
      "top" == c || "right" == c ? "bottom" : "top"
  },
  updateChartScrollbar: function(a, b) {
    if (a) {
      ...
      "top" == a.position ? b ? (a.y = c,
        a.x = d - e) : (a.y = c - e + g,
        a.x = d + f) : b ? (a.y = c + g,
        a.x = d + this.plotAreaWidth + f) : (a.y = c + this.plotAreaHeight +
        1,
...
AmCharts.TrendLine = AmCharts.Class({
  ...
  draw: function() {
    ...
    h && (k && (d = h.dateToCoordinate(k)),
      l && (d = h.categoryToCoordinate(l)),
      m && (e = h.dateToCoordinate(m)),
      p && (e = h.categoryToCoordinate(p)));
    n && !t && (isNaN(s) || (d = n.getCoordinate(s)),
      isNaN(q) || (e = n.getCoordinate(q)));
    r && !t && (isNaN(v) || (f = r.getCoordinate(v)),
      isNaN(u) || (g = r.getCoordinate(u)));
    isNaN(d) || (isNaN(e) || isNaN(f) || isNaN(f)) || (b.rotate ? (h = [f,
          g
        ],
        e = [d, e]) : (h = [d, e],
        e = [f, g]),
      f = a.lineColor,
      d = AmCharts.line(c, h, e, f, a.lineAlpha, a.lineThickness, a.dashLength),
      e = AmCharts.line(c, h, e, f, 0.005, 5),
      c = c.set([d, e]),
...
AmCharts.AmSerialChart = AmCharts.Class({
  ...
  validateData: function(a) {
    this.marginsUpdated = !1;
    this.zoomOutOnDataUpdate && !a && (this.endTime = this.end = this.startTime =
      this.start = NaN);
  ...
  cleanChart: function() {
    AmCharts.callMethod("destroy", [this.valueAxes, this.graphs, this.categoryAxis,
      this.chartScrollbar, this.chartCursor
    ])
  },
  ...
  updateData: function() {
    ...
    for (b = 0; b < a.length; b++)
      a[b].data = c;
    0 < c.length && (this.firstTime = this.getStartTime(c[0].time),
      this.lastTime = this.getEndTime(c[c.length - 1].time))
  },
  getStartTime: function(a) {
    var b = this.categoryAxis;
    return AmCharts.resetDateToMin(new Date(a), b.minPeriod, 1, b.firstDayOfWeek)
      .getTime()
  },
  getEndTime: function(a) {
    var b = AmCharts.extractPeriod(this.categoryAxis.minPeriod);
    return AmCharts.changeDate(new Date(a), b.period, b.count, !0).getTime() -
      1
  },
  updateMargins: function() {
  ...
  zoom: function(a, b) {
    ...
    c.parseDates && !c.equalSpacing ? this.timeZoom(a, b) : this.indexZoom(
      a, b)
  },
  ...
  indexZoom: function(a, b) {
    ...
    if (a != this.start || b != this.end) {
      ...
      this.zoomAxesAndGraphs();
      this.zoomScrollbar();
      0 !== a || b != this.chartData.length - 1 ? this.showZB(!0) : this.showZB(!
        1);
      this.updateColumnsDepth();
  ...
  zoomScrollbar: function() {
    var a = this.chartScrollbar,
      b = this.categoryAxis;
    a && this.updateScrollbar && (b.parseDates && !b.equalSpacing ? a.timeZoom(
        this.startTime, this.endTime) : a.zoom(this.start, this.end),
      this.updateScrollbar = !0)
  },
  ...
  zoomAxesAndGraphs: function() {
    if (!this.scrollbarOnly) {
      ...
      for (b = 0; b < a.length; b++)
        a[b].zoom(this.start, this.end);
      this.zoomTrendLines();
      (b = this.chartCursor) && b.zoom(this.start, this.end, this.startTime,
        this.endTime)
    }
  },
    ...
    for (h = 0; h < b; h++) {
      ...
      if ("100%" == k || "regular" == k)
        for (f = !1,
          g = 0; g < c; g++)
          d = this.graphs[g],
          d.hidden || (d.valueAxis != e || "column" != d.type) || (!f &&
            d.stackable && (a++,
              f = !0),
            d.stackable || a++,
            d.columnIndex = a - 1);
      if ("none" == k || "3d" == k)
        for (g = 0; g < c; g++)
          d = this.graphs[g],
          d.hidden || (d.valueAxis != e || "column" != d.type) || (d.columnIndex =
            a,
            a++);
      if ("3d" == k) {
        for (h = 0; h < c; h++)
  ...
  updateLegendValues: function(a) {
    ...
    for (c = 0; c < b.length; c++) {
      var d = b[c];
      isNaN(a) ? d.currentDataItem = void 0 : d.currentDataItem = this.chartData[
        a].axes[d.valueAxis.id].graphs[d.id]
    }
  ...
  getClosestIndex: function(a, b, c, d, e, f) {
    ...
    return c == h ? g : c < h ? this.getClosestIndex(a, b, c, d, e, g) :
  ...
  zoomToIndexes: function(a, b) {
    ...
    if (c) {
      ...
      0 < d && (0 > a && (a = 0),
        b > d - 1 && (b = d - 1),
        d = this.categoryAxis,
        d.parseDates && !d.equalSpacing ? this.zoom(c[a].time, this.getEndTime(
          c[b].time)) : this.zoom(a, b))
    }
  },
  ...
  zoomToCategoryValues: function(a, b) {
    this.updateScrollbar = !0;
    this.zoom(this.getCategoryIndexByValue(a), this.getCategoryIndexByValue(
      b))
  },
  formatString: function(a, b) {
    var c = b.graph;
    if (-1 != a.indexOf("[[category]]")) {
      ...
      if (this.categoryAxis.parseDates) {
        var e = this.balloonDateFormat,
          f = this.chartCursor;
        f && (e = f.categoryBalloonDateFormat); - 1 != a.indexOf(
          "[[category]]") && (e = AmCharts.formatDate(d, e), -1 != e.indexOf(
            "fff") && (e = AmCharts.formatMilliseconds(e, d)),
          d = e)
      }
    ...
    d = b.graph.valueAxis;
    (e = d.duration) && !isNaN(b.values.value) && (d = AmCharts.formatDuration(
        b.values.value, e, "", d.durationUnits, d.maxInterval, c),
    ...
    a = AmCharts.formatValue(a, b.values, d, c, "", this.usePrefixes,
      this.prefixesOfSmallNumbers, this.prefixesOfBigNumbers);
    a = AmCharts.formatValue(a, b.values, ["percents"], e); - 1 != a.indexOf(
  ...
  addChartScrollbar: function(a) {
    ...
    this.rotate ? void 0 === a.width && (a.width = a.scrollbarHeight) :
...
AmCharts.AmRadarChart = AmCharts.Class({
  ...
  formatString: function(a, b) {
    var c = b.graph; - 1 != a.indexOf("[[category]]") && (a = a.replace(
      /\[\[category\]\]/g, String(b.serialDataItem.category)));
    c = c.numberFormatter;
    c || (c = this.numberFormatter);
    a = AmCharts.formatValue(a, b.values, ["value"], c, "", this.usePrefixes,
      this.prefixesOfSmallNumbers, this.prefixesOfBigNumbers); - 1 != a.indexOf(
      "[[") && (a = AmCharts.formatDataContextValue(a, b.dataContext));
...
AmCharts.AxisBase = AmCharts.Class({
  ...
  draw: function() {
    ...
    this.autoGridCount && ("V" == this.orientation ? (a = this.height /
        35,
        3 > a && (a = 3)) : a = this.width / this.minGap,
      this.gridCount = Math.max(a, 1));
  ...
  addTitle: function() {
    ...
    if (a) {
      var b = this.chart;
      this.titleLabel = AmCharts.text(b.container, a, this.titleColor, b.fontFamily,
        this.titleFontSize, "middle", this.titleBold)
    }
  },
...
AmCharts.ValueAxis = AmCharts.Class({
  ...
  construct: function() {
    this.createEvents("axisChanged", "logarithmicAxisFailed",
      "axisSelfZoomed", "axisZoomed");
    ...
    this.recalculateToPercents = this.includeHidden = this.includeGuidesInMinMax =
      this.integersOnly = !1;
    this.durationUnits = {
      DD: "d. ",
      hh: ":",
  ...
  updateData: function() {
    ...
    this.synchronizationMultiplier && this.synchronizeWith ? this.foundGraphs = !
      0 : (this.foundGraphs = !1,
        this.getMinMax())
  },
  draw: function() {
    ...
    !0 === this.dataChanged && (this.updateData(),
      this.dataChanged = !1);
    if (this.logarithmic && (0 >= this.getMin(0, this.data.length - 1) ||
        0 >= this.minimum))
      ...
      if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs ||
        ...
        var l = this.labelFrequency,
          ...
          q;
        !0 === h ? (q = Math.log(this.max) * Math.LOG10E - Math.log(this.minReal) *
            Math.LOG10E,
            this.stepWidth = this.axisWidth / q,
            2 < q && (s = Math.ceil(Math.log(this.max) * Math.LOG10E) + 1,
              n = Math.round(Math.log(this.minReal) * Math.LOG10E),
              s > this.gridCount && (r = Math.ceil(s / this.gridCount)))) :
        ...
        if (0 < y) {
          ...
          for (d = this.fillAlpha = 0; d < y; d++) {
            var A = w[d],
              z = NaN,
              H = A.above;
            isNaN(A.toValue) || (z = this.getCoordinate(A.toValue),
              t = new this.axisItemRenderer(this, z, "", !0, NaN, NaN,
                A),
              this.pushAxisItem(t, H));
            var E = NaN;
            isNaN(A.value) || (E = this.getCoordinate(A.value),
              t = new this.axisItemRenderer(this, E, A.label, !0, NaN, (
                z - E) / 2, A),
              this.pushAxisItem(t, H));
            isNaN(z - E) || (t = new this.guideFillRenderer(this, E, z, A),
              this.pushAxisItem(t, H),
              t = t.graphics(),
              A.graphics = t,
              A.balloonText && this.addEventListeners(t, A))
          }
          this.fillAlpha = x
        }
        w = !1;
        for (d = n; d < s; d += r)
          t = AmCharts.roundTo(this.step * d + this.min, c), -1 != String(
            t).indexOf("e") && (w = !0,
            String(t).split("e"));
        this.duration && (this.maxInterval = AmCharts.getMaxInterval(this
          .max, this.duration));
        for (d = n; d < s; d += r)
          if (n = this.step * d + this.min,
            n = AmCharts.roundTo(n, this.maxDecCount + 1), !this.integersOnly ||
            Math.round(n) == n)
            if (isNaN(v) || Number(AmCharts.toFixed(n, v)) == n) {
              !0 === h && (0 === n && (n = this.minReal),
                2 < q && (n = Math.pow(10, d)),
                w = -1 != String(n).indexOf("e") ? !0 : !1);
              this.useScientificNotation && (w = !0);
              this.usePrefixes && (w = !1);
              w ? (t = -1 == String(n).indexOf("e") ? n.toExponential(15) :
                String(n),
                t = t.split("e"),
                c = Number(t[0]),
                t = Number(t[1]),
                c = AmCharts.roundTo(c, 14),
                10 == c && (c = 1,
                  t += 1),
                t = c + "e" + t,
                0 === n && (t = "0"),
                1 == n && (t = "1")) : (h && (c = String(n).split("."),
                  u.precision = c[1] ? c[1].length : -1),
                t = this.usePrefixes ? AmCharts.addPrefix(n, a.prefixesOfBigNumbers,
                  a.prefixesOfSmallNumbers, u, !0) : AmCharts.formatNumber(
                  n, u, u.precision));
              this.duration && (t = AmCharts.formatDuration(n, this.duration,
                "", this.durationUnits, this.maxInterval, u));
              this.recalculateToPercents ? t += "%" : (c = this.unit) &&
                (t = "left" == this.unitPosition ? c + t : t + c);
              Math.round(d / l) != d / l && (t = void 0);
              if (0 === d && !m || d == s - 1 && !p)
                t = " ";
              c = this.getCoordinate(n);
              this.labelFunction && (t = this.labelFunction(n, t, this));
              ...
              if (n == this.baseValue && "radar" != k) {
                var I, K, y = this.viW,
                  ...
                  n = this.viX;
                t = this.viY;
                "H" == this.orientation ? 0 <= c && c <= y + 1 && (I = [c,
                    c, c + e
                  ],
                  ...
                  K = [c, c, c + f]);
                I && (c = AmCharts.fitToBounds(2 * this.gridAlpha, 0, 1),
                  c = AmCharts.line(a.container, I, K, this.gridColor,
                    c, 1, this.dashLength),
                  c.translate(n, t),
                  this.grid0 = c,
                  a.axesSet.push(c),
      ...
      "radar" != k ? (k = this.viX,
        d = this.viY,
        b.translate(k, d),
        a.translate(k, d)) : h.toFront();
      !this.visible || g ? (b.hide(),
        h.hide(),
        a.hide()) : (b.show(),
        h.show(),
        a.show())
  ...
  getDecimals: function(a) {
    var b = 0;
    isNaN(a) || (a = String(a), -1 != a.indexOf("e-") ? b = Number(a.split(
      "-")[1]) : -1 != a.indexOf(".") && (b = a.split(".")[1].length));
    return b
  },
  stackGraphs: function(a) {
    ...
    if (n && ("regular" == b || "100%" == b))
      for (p = 0; p < h.length; p++)
        m = h[p],
        m.hidden || (l = m.type,
          m.chart == this.chart && (m.valueAxis == this && a == l && m.stackable) &&
          (k && (m.stackGraph = k),
            k = m));
    for (k = this.start; k <= this.end; k++) {
      var s = 0;
      for (p = 0; p < h.length; p++)
        if (m = h[p], !m.hidden && (l = m.type,
            m.chart == this.chart && (m.valueAxis == this && a == l && m.stackable) &&
            (l = this.data[k].axes[this.id].graphs[m.id],
          ...
          m = m.fillToGraph;
          n && m && (m = this.data[k].axes[this.id].graphs[m.id]) && (l.values
            .open = m.values.value);
          "regular" == b && (n && (isNaN(c[k]) ? (c[k] = g,
              l.values.close = g,
              l.values.open = this.baseValue) : (isNaN(g) ? l.values.close =
              c[k] : l.values.close = g + c[k],
              l.values.open = c[k],
              c[k] = l.values.close)),
            "column" != a || isNaN(g) || (l.values.close = g,
              0 > g ? (l.values.close = g,
                isNaN(d[k]) ? l.values.open = r : (l.values.close += d[
                    k],
                  l.values.open = d[k]),
                d[k] = l.values.close) : (l.values.close = g,
                isNaN(e[k]) ? l.values.open = r : (l.values.close += e[
                    k],
                  l.values.open = e[k]),
                e[k] = l.values.close)))
        }
        ...
        m.hidden || (l = m.type,
          ...
          (l = this.data[k].axes[this.id].graphs[m.id],
            ...
            isNaN(g) || (c = 100 * (g / f[k]),
              l.values.percents = c,
              l.values.total = f[k],
              "100%" == b && (isNaN(d[k]) && (d[k] = 0),
                isNaN(e[k]) && (e[k] = 0),
                0 > c ? (l.values.close = AmCharts.fitToBounds(c + d[k], -
                    100, 100),
                  l.values.open = d[k],
                  d[k] = l.values.close) : (l.values.close = AmCharts.fitToBounds(
                    c + e[k], -100, 100),
                  l.values.open = e[k],
                  e[k] = l.values.close)))))
  },
  recalculate: function() {
    ...
    for (b = 0; b < a.length; b++) {
      ...
      if (c.valueAxis == this) {
        ...
        for (k = f; k <= g && (f = this.data[k].axes[this.id].graphs[c.id],
            e = f.values[d],
            isNaN(e)); k++)
        ;
        for (d = h; d <= g; d++) {
          ...
          var h = f.values,
            l;
          for (l in h)
            f.percents[l] = "percents" != l ? 100 * (h[l] / e) - 100 : h[
              l]
        }
      }
    }
  ...
  getMinMax: function() {
    ...
    for (d = 0; d < c.length; d++) {
      var e = c[d].type;
      ("line" == e || "step" == e || "smoothedLine" == e) && this.expandMinMax &&
        (a = !0)
    }
    a && (0 < this.start && this.start--,
      this.end < this.data.length - 1 && this.end++);
    "serial" == b.chartType && (!0 !== b.categoryAxis.parseDates || a ||
      this.end < this.data.length - 1 && this.end++);
    ...
    b = this.max;
    c = this.max - this.min;
    d = 0 === c ? Math.pow(10, Math.floor(Math.log(Math.abs(this.max)) *
      Math.LOG10E)) / 10 : Math.pow(10, Math.floor(Math.log(Math.abs(c)) *
      Math.LOG10E)) / 10;
    isNaN(this.maximum) && isNaN(this.maxTemp) && (this.max = Math.ceil(
      this.max / d) * d + d);
    isNaN(this.minimum) && isNaN(this.minTemp) && (this.min = Math.floor(
      this.min / d) * d - d);
    ...
    0 > this.min && 0 <= a && (this.min = 0);
    0 < this.max && 0 >= b && (this.max = 0);
    1 < this.minReal && 1 < this.max - this.minReal && (this.minReal =
      Math.floor(this.minReal));
    c = Math.pow(10, Math.floor(Math.log(Math.abs(this.minReal)) * Math.LOG10E));
    0 === this.min && (this.minReal = c);
    0 === this.min && 1 < this.minReal && (this.minReal = 1);
    0 < this.min && 0 < this.minReal - this.step && (this.minReal = this.min +
      this.step < this.minReal ? this.min + this.step : this.min);
    c = Math.log(b) * Math.LOG10E - Math.log(a) * Math.LOG10E;
    this.logarithmic && (2 < c ? (this.minReal = this.min = Math.pow(10,
        Math.floor(Math.log(Math.abs(a)) * Math.LOG10E)),
      this.max = Math.pow(10, Math.ceil(Math.log(Math.abs(b)) * Math.LOG10E))
    ) : (b = Math.pow(10, Math.floor(Math.log(Math.abs(this.min)) *
        Math.LOG10E)) / 10,
      ...
      for (f in e)
        if (e.hasOwnProperty(f)) {
          ...
          if (g.includeInMinMax && (!g.hidden || this.includeHidden)) {
            ...
            var h;
            if (this.minMaxField)
              h = g[this.minMaxField],
              h < c && (c = h);
            else
              for (var k in g)
                g.hasOwnProperty(k) && ("percents" != k && "total" != k) &&
                (h = g[k],
                  h < c && (c = h))
          }
        }
      ...
      for (d in c)
        if (c.hasOwnProperty(d)) {
          ...
          if (e.includeInMinMax && (!e.hidden || this.includeHidden)) {
            ...
            var f;
            if (this.minMaxField)
              f = e[this.minMaxField],
              f > a && (a = f);
            else
              for (var g in e)
                e.hasOwnProperty(g) && ("percents" != g && "total" != g) &&
                (f = e[g],
                  f > a && (a = f))
          }
        }
  ...
  zoomToValues: function(a, b) {
    ...
    c.multiplier = this.axisWidth / Math.abs(this.getCoordinate(b) - this
      .getCoordinate(a));
    c.position = "V" == this.orientation ? this.reversed ? this.getCoordinate(
        a) : this.getCoordinate(b) : this.reversed ? this.getCoordinate(b) :
  ...
  coordinateToValue: function(a) {
    ...
    var b = this.axisWidth,
      ...
      f = this.min,
      g = this.minReal;
    return !0 === this.logarithmic ? Math.pow(10, (e ? !0 === d ? (b - a) /
          c : a / c : !0 === d ? a / c : (b - a) / c) + Math.log(g) *
        Math.LOG10E) : !0 === d ? e ? f - (a - b) / c : a / c + f : e ? a /
      c + f : f - (a - b) / c
  },
  getCoordinate: function(a) {
    ...
    var b = this.rotate,
      ...
      f = this.min,
      g = this.minReal;
    !0 === this.logarithmic ? (a = Math.log(a) * Math.LOG10E - Math.log(g) *
      Math.LOG10E,
      b = b ? !0 === c ? d - e * a : e * a : !0 === c ? e * a : d - e *
      a) : b = !0 === c ? b ? d - e * (a - f) : e * (a - f) : b ? e * (
      a - f) : d - e * (a - f);
  ...
  handleSynchronization: function(a) {
    ...
    d && (this.min = a * d,
      this.max = c * d,
      this.step = b * d,
      a = Math.pow(10, Math.floor(Math.log(Math.abs(this.step)) * Math.LOG10E)),
...
AmCharts.CategoryAxis = AmCharts.Class({
  ...
  draw: function() {
    ...
    if (AmCharts.ifArray(a)) {
      ...
      var v = this.firstDayOfWeek,
        ...
        a = AmCharts.resetDateToMin(new Date(a[a.length - 1].time + 1.05 *
          l), this.minPeriod, 1, v).getTime(),
        t;
      ...
      if (this.parseDates && !this.equalSpacing) {
        ...
        e = d.period;
        p = d.count;
        r = AmCharts.getPeriodDuration(e, p);
        r < l && (e = m.period,
          p = m.count,
          r = l);
        n = e;
        ...
        var g = Math.ceil(this.timeDifference / r) + 5,
          w = m = AmCharts.resetDateToMin(new Date(this.startTime - r), e,
            p, v).getTime();
        n == e && (1 == p && this.centerLabelOnFullPeriod) && (s = r *
          this.stepWidth);
        this.cellWidth = l * this.stepWidth;
        b = Math.round(m / r);
        d = -1;
        b / 2 == Math.round(b / 2) && (d = -2,
          m -= r);
        var y = c.firstTime;
        if (0 < this.gridCount)
          for (b = d; b <= g; b++) {
            ...
            q = !1;
            this.nextPeriod[n] && (q = this.checkPeriodChange(this.nextPeriod[
              n], 1, a, m));
            t = !1;
            q && this.markPeriodChange ? (m = this.dateFormatsObject[this
                .nextPeriod[n]],
              t = !0) : m = this.dateFormatsObject[n];
            u || (t = !1);
            m = AmCharts.formatDate(new Date(a), m);
            if (b == d && !h || b == g && !k)
              m = " ";
            this.labelFunction && (m = this.labelFunction(m, new Date(a),
              this));
            m = new this.axisItemRenderer(this, l, m, !1, s, 0, !1, t);
            this.pushAxisItem(m);
            m = a
          }
      } else if (!this.parseDates) {
        if (this.cellWidth = this.getStepWidth(b),
          b < g && (g = b),
          f += this.start,
          this.stepWidth = this.getStepWidth(b),
          0 < g)
          for (u = Math.floor(b / g),
            l = f,
            l / 2 == Math.round(l / 2) && l--,
            0 > l && (l = 0),
            g = 0,
            b = l; b <= this.end + 2; b++)
            if (0 <= b && b < this.data.length ? (n = this.data[b],
                m = n.category) : m = "",
              b / u == Math.round(b / u) || n.forceShow) {
              ...
              s = this.cellWidth;
              p && (s = NaN);
              this.labelFunction && (m = this.labelFunction(m, n, this));
              m = AmCharts.fixNewLines(m);
              m = new this.axisItemRenderer(this, l, m, !0, s, v, void 0, !
                1, v);
              this.pushAxisItem(m)
            }
        ...
        m = AmCharts.resetDateToMin(new Date(this.startTime - r), e, p, v)
          .getTime();
        ...
        if (this.data[l].time != AmCharts.resetDateToMin(new Date(this.data[
            l].time), e, p, v).getTime())
          for (v = 0,
            w = m,
            b = l; b < s; b++)
            a = this.data[b].time,
            this.checkPeriodChange(e, p, a, w) && (v++,
              2 <= v && (l = b,
                b = s),
              w = a);
        for (b = l; b < s; b++)
          if (a = this.data[b].time,
            this.checkPeriodChange(e, p, a, m)) {
            ...
            if (b == d && !h || b == g && !k)
              m = " ";
            r ? r = !1 : (u || (t = !1),
              l - this.previousPos > this.safeDistance * Math.cos(this.labelRotation *
                Math.PI / 180) && (this.labelFunction && (m = this.labelFunction(
                  m, new Date(a), this)),
                m = new this.axisItemRenderer(this, l, m, void 0, void 0,
                  void 0, void 0, t),
                v = m.graphics(),
                this.pushAxisItem(m),
      ...
      for (b = 0; b < this.data.length; b++)
        if (h = this.data[b])
          k = this.parseDates && !this.equalSpacing ? Math.round((h.time -
            this.startTime) * this.stepWidth + this.cellWidth / 2) : this
          .getCoordinate(b - f),
          h.x[this.id] = k;
      ...
      for (b = 0; b < h; b++)
        ...
        v = v = v = g = u = NaN,
        d = k.above,
        k.toCategory && (v = c.getCategoryIndexByValue(k.toCategory),
          isNaN(v) || (u = this.getCoordinate(v - f),
            m = new this.axisItemRenderer(this, u, "", !0, NaN, NaN, k),
            this.pushAxisItem(m, d))),
        k.category && (v = c.getCategoryIndexByValue(k.category),
          isNaN(v) || (g = this.getCoordinate(v - f),
            v = (u - g) / 2,
            m = new this.axisItemRenderer(this, g, k.label, !0, NaN, v, k),
            this.pushAxisItem(m, d))),
        k.toDate && (this.equalSpacing ? (v = c.getClosestIndex(this.data,
              "time", k.toDate.getTime(), !1, 0, this.data.length - 1),
            isNaN(v) || (u = this.getCoordinate(v - f))) : u = (k.toDate.getTime() -
            this.startTime) * this.stepWidth,
          m = new this.axisItemRenderer(this, u, "", !0, NaN, NaN, k),
          this.pushAxisItem(m, d)),
        k.date && (this.equalSpacing ? (v = c.getClosestIndex(this.data,
              "time", k.date.getTime(), !1, 0, this.data.length - 1),
            isNaN(v) || (g = this.getCoordinate(v - f))) : g = (k.date.getTime() -
            this.startTime) * this.stepWidth,
          v = (u - g) / 2,
          m = "H" == this.orientation ? new this.axisItemRenderer(this, g,
            k.label, !1, 2 * v, NaN, k) : new this.axisItemRenderer(this,
            g, k.label, !1, NaN, v, k),
          this.pushAxisItem(m, d)),
        u = new this.guideFillRenderer(this, g, u, k),
        g = u.graphics(),
        this.pushAxisItem(u, d),
        k.graphics = g,
        g.index = b,
        k.balloonText && this.addEventListeners(g, k)
    }
    this.axisCreated = !0;
    c = this.x;
    f = this.y;
  ...
  choosePeriod: function(a) {
    var b = AmCharts.getPeriodDuration(this.periods[a].period, this.periods[
        a].count),
      c = Math.ceil(this.timeDifference / b),
      d = this.periods;
    return this.timeDifference < b && 0 < a ? d[a - 1] : c <= this.gridCount ?
      d[a] : a + 1 < d.length ? this.choosePeriod(a + 1) : d[a]
  },
  ...
  checkPeriodChange: function(a, b, c, d) {
    ...
    return "DD" == a && c - b <= AmCharts.getPeriodDuration(a, d) ? !1 :
      c != b ? !0 : !1
  },
  ...
  xToIndex: function(a) {
    var b = this.data,
      ...
      d = c.rotate,
      e = this.stepWidth;
    this.parseDates && !this.equalSpacing ? (a = this.startTime + Math.round(
        a / e) - this.minDuration() / 2,
  ...
  dateToCoordinate: function(a) {
    return this.parseDates && !this.equalSpacing ? (a.getTime() - this.startTime) *
      this.stepWidth : this.parseDates && this.equalSpacing ? (a = this.chart
        .getClosestIndex(this.data, "time", a.getTime(), !1, 0, this.data
          .length - 1),
  ...
  coordinateToDate: function(a) {
    return this.equalSpacing ? (a = this.xToIndex(a),
      new Date(this.data[a].time)) : new Date(this.startTime + a / this
      .stepWidth)
  }
});
AmCharts.RecAxis = AmCharts.Class({
  construct: function(a) {
    var b = a.chart,
      ...
      p = a.viW,
      r = b.container;
    "H" == a.orientation ? (d = AmCharts.line(r, [0, p], [0, 0], d, e, c),
      this.axisWidth = a.width,
      "bottom" == a.position ? (a = c / 2 + f + m + l - 1,
        c = k) : (a = -c / 2 - f + l + h,
        c = g + k)) : (this.axisWidth = a.height,
      "right" == a.position ? (d = AmCharts.line(r, [0, 0, -g], [0, m,
          m - h
        ], d, e, c),
        a = l + h,
        c = c / 2 + f + g + p + k - 1) : (d = AmCharts.line(r, [0, 0], [
          0, m
        ], d, e, c),
        a = l,
        c = -c / 2 - f + k));
...
AmCharts.RecItem = AmCharts.Class({
  construct: function(a, b, c, d, e, f, g, h, k) {
    ...
    var s = a.axisThickness,
      ...
      ma, X;
    g ? (H = !0,
      isNaN(g.tickLength) || (u = g.tickLength),
      void 0 != g.lineColor && (y = g.lineColor),
      void 0 != g.color && (p = g.color),
      isNaN(g.lineAlpha) || (t = g.lineAlpha),
      isNaN(g.dashLength) || (x = g.dashLength),
      isNaN(g.lineThickness) || (w = g.lineThickness), !0 === g.inside &&
      (K = !0),
      isNaN(g.labelRotation) || (E = g.labelRotation),
      isNaN(g.fontSize) || (m = g.fontSize),
      g.position && (da = g.position)) : "" === c && (u = 0);
    X = "start";
    e && (X = "middle");
    var Y = E * Math.PI / 180,
      ka, G = 0,
    ...
    "V" == Fa && (E = 0);
    var U;
    H && (U = AmCharts.text(r, c, p, l, m, X, h),
      ga = U.getBBox().width);
    if ("H" == Fa) {
      if (0 <= b && b <= R + 1 && (0 < u && (0 < v && b + k <= R + 1) &&
          (ma = AmCharts.line(r, [b + k, b + k], [0, u], q, v, w),
            n.push(ma)),
          0 < t && (X = AmCharts.line(r, [b, b + S, b + S], [T, T + Q, Q],
              y, t, w, x),
            n.push(X))),
        B = 0,
        G = b,
        g && 90 == E && (G -= m), !1 === d ? (X = "start",
          B = "bottom" == da ? K ? B + u : B - u : K ? B - u : B + u,
          G += 3,
          e && (G += e / 2,
            X = "middle"),
          0 < E && (X = "middle")) : X = "middle",
        1 == I && (0 < z && !g && ha < R) && (d = AmCharts.fitToBounds(b,
            0, R),
          ha = AmCharts.fitToBounds(ha, 0, R),
          ka = d - ha,
          0 < ka && (fill = AmCharts.rect(r, ka, a.height, A, z),
            fill.translate(d - ka + S, Q),
            n.push(fill))),
        "bottom" == da ? (B += T + m / 2 + W,
          K ? 0 < E ? (B = T - ga / 2 * Math.sin(Y) - u - 3,
            G += ga / 2 * Math.cos(Y)) : B -= u + m + 3 + 3 : 0 < E ? (B =
            T + ga / 2 * Math.sin(Y) + u + 3,
            G -= ga / 2 * Math.cos(Y)) : B += u + s + 3 + 3) : (B += Q +
          m / 2 - W,
          G += S,
          K ? 0 < E ? (B = ga / 2 * Math.sin(Y) + u + 3,
            G -= ga / 2 * Math.cos(Y)) : B += u + 3 : 0 < E ? (B = -(ga /
              2) * Math.sin(Y) - u - 6,
            G += ga / 2 * Math.cos(Y)) : B -= u + m + 3 + s + 3),
        "bottom" == da ? ka = (K ? T - u - 1 : T + s - 1) + W : ($ = S,
          ka = (K ? Q : Q - u - s + 1) - W),
        f && (G += f),
        Q = G,
        0 < E && (Q += ga / 2 * Math.cos(Y)),
        U && (da = 0,
          K && (da = ga / 2 * Math.cos(Y)),
          Q + da > R + 2 || 0 > Q))
        U.remove(),
        U = null
    } else {
      0 <= b && b <= T + 1 && (0 < u && (0 < v && b + k <= T + 1) && (ma =
          AmCharts.line(r, [0, u], [b + k, b + k], q, v, w),
          n.push(ma)),
        0 < t && (X = AmCharts.line(r, [0, S, R + S], [b, b + Q, b + Q],
            y, t, w, x),
          n.push(X)));
      X = "end";
      if (!0 === K && "left" == da || !1 === K && "right" == da)
        X = "start";
      B = b - m / 2;
      1 == I && (0 < z && !g) && (d = AmCharts.fitToBounds(b, 0, T),
        ha = AmCharts.fitToBounds(ha, 0, T),
        Y = d - ha,
        fill = AmCharts.polygon(r, [0, a.width, a.width, 0], [0, 0, Y,
          Y
        ], A, z),
        fill.translate(S, d - Y + Q),
        n.push(fill));
      B += m / 2;
      "right" == da ? (G += S + R + W,
        B += Q,
...
AmCharts.RecFill = AmCharts.Class({
  construct: function(a, b, c, d) {
    ...
    k = a.chart.container;
    d = d.fillColor;
    "V" == g ? (b = AmCharts.fitToBounds(b, 0, a.viH),
      c = AmCharts.fitToBounds(c, 0, a.viH)) : (b = AmCharts.fitToBounds(
        b, 0, a.viW),
      c = AmCharts.fitToBounds(c, 0, a.viW));
    c -= b;
    isNaN(c) && (c = 4,
      h = 2,
      l = 0);
    0 > c && "object" == typeof d && (d = d.join(",").split(",").reverse());
    "V" == g ? (a = AmCharts.rect(k, a.width, c, d, l),
      a.translate(e, b - h + f)) : (a = AmCharts.rect(k, c, a.height, d,
        l),
      a.translate(b - h + e, f));
    this.set = k.set([a])
  },
  ...
  construct: function(a) {
    ...
    if (b) {
      ...
      for (n = 0; n < r; n++) {
        ...
        0 < e && (q = AmCharts.line(b.container, [f, q], [g, v], d, e, c),
          this.set.push(q));
        if (k) {
          var u = "start",
          ...
          180 == s && (v -= 5);
          0 === s && (v += 5);
          s = AmCharts.text(b.container, a[n].category, p, l, m, u);
          s.translate(q + 5, v);
          this.set.push(s);
          s.getBBox()
        }
...
AmCharts.RadItem = AmCharts.Class({
  construct: function(a, b, c, d, e, f, g) {
    ...
    var E = a.y;
    g ? (y = !0,
      isNaN(g.tickLength) || (n = g.tickLength),
      void 0 != g.lineColor && (v = g.lineColor),
      isNaN(g.lineAlpha) || (s = g.lineAlpha),
      isNaN(g.dashLength) || (u = g.dashLength),
      isNaN(g.lineThickness) || (q = g.lineThickness), !0 === g.inside &&
      (x = !0)) : c || (s /= 3,
      n /= 2);
    var I = "end",
      K = -1;
    x && (I = "start",
      K = 1);
    var S;
    y && (S = AmCharts.text(m, c, l, h, k, I),
      S.translate(f + (n + 3) * K, b),
      d.push(S),
      this.label = S,
      H = AmCharts.line(m, [f, f + n * K], [b, b], p, r, q),
      d.push(H));
    b = a.y - b;
    c = [];
    h = [];
    if (0 < s) {
      if ("polygons" == A) {
        ...
        for (k = 0; k < z; k++)
          l = 180 - 360 / z * k,
          c.push(b * Math.sin(l / 180 * Math.PI)),
    ...
    if (1 == e && 0 < w && !g) {
      ...
      if ("polygons" == A) {
        for (k = z; 0 <= k; k--)
          l = 180 - 360 / z * k,
          c.push(g * Math.sin(l / 180 * Math.PI)),
          h.push(g * Math.cos(l / 180 * Math.PI));
...
AmCharts.RadarFill = AmCharts.Class({
  construct: function(a, b, c, d) {
    ...
    if ("polygons" == a.gridType) {
      ...
      for (m = 0; m < l; m++)
        h = 180 - 360 / l * m,
        d.push(e * Math.sin(h / 180 * Math.PI)),
        k.push(e * Math.cos(h / 180 * Math.PI));
      d.push(d[0]);
      k.push(k[0]);
      for (m = l; 0 <= m; m--)
        h = 180 - 360 / l * m,
        d.push(b * Math.sin(h / 180 * Math.PI)),
...
AmCharts.AmGraph = AmCharts.Class({
  ...
  draw: function() {
    ...
    this.behindColumns ? (a.graphsBehindSet.push(c),
      a.bulletBehindSet.push(d)) : (a.graphsSet.push(c),
      a.bulletSet.push(d));
    this.bulletSet = d;
    if (!this.scrollbar) {
    ...
    this.allBullets = [];
    this.animationArray = [];
    AmCharts.ifArray(this.data) && (c = !1,
      "xy" == this.chartType ? this.xAxis.axisCreated && this.yAxis.axisCreated &&
      (c = !0) : this.valueAxis.axisCreated && (c = !0), !this.hidden &&
      c && this.createGraph())
  },
  createGraph: function() {
    ...
    void 0 === a.bulletColor && (a.bulletColor = a.lineColor,
    ...
    if (!isNaN(a.valueAxis.min) && !isNaN(a.valueAxis.max)) {
      switch (a.chartType) {
        case "serial":
          a.createSerialGraph();
          "candlestick" == a.type && 1 > a.valueAxis.minMaxMultiplier &&
  ...
  createXYGraph: function() {
    ...
    for (e = this.start; e <= this.end; e++) {
      var f = this.data[e].axes[c.id].graphs[this.id],
        ...
        g = c.getCoordinate(h),
        l = d.getCoordinate(k);
      !isNaN(h) && !isNaN(k) && (a.push(g),
        b.push(l), (h = this.createBullet(f, g, l, e)) || (h = 0),
        k = this.labelText) && (f = this.createLabel(f, g, l, k),
        this.allBullets.push(f),
        this.positionLabel(g, l, f, this.labelPosition, h))
    }
  ...
  createSerialGraph: function() {
    var a = this.chart,
      ...
      q = [],
      v = [],
      u, t, w, y, x = this.chart.graphs.length,
      A, z = this.dx / this.depthCount,
    ...
    var U, F, Qa, Ya = l + 1,
      ...
      Ra = 0,
      $a = 0,
      ab, bb, Sa, Ta, Eb = this.fillColors,
    ...
    if (!Q && ("line" == g || "smoothedLine" == g || "step" == g) && (1 ==
        d.length && ("step" != g && "none" == this.bullet) && (this.bullet =
          "round",
          this.resetBullet = !0),
        Ga || void 0 != ya)) {
      var Ca = ha;
    ...
    this.nmh = va(ab);
    this.nmw = va(bb);
    9 > AmCharts.IEversion && 0 < AmCharts.IEversion && (this.nmy = this.nmx =
      0,
      this.nmh = this.height);
    h = "column" == g ? ($ * h - B * (r - 1)) / r : $ * h;
    1 > h && (h = 1);
    var O;
    ...
    for (O = K; O <= S; O++) {
      ...
      var L, M, J, aa, na = NaN,
        ...
        qa = ma,
        ja, ra;
      void 0 != F.color && (wa = F.color);
      F.fillColors && (wa = F.fillColors);
      isNaN(F.alpha) || (Ma = F.alpha);
      var sa = F.values;
      ...
      if (sa) {
        ...
        if ("candlestick" == g || "ohlc" == g)
          V = sa.close,
          db = sa.low,
          za = f.getCoordinate(db),
          cb = sa.high,
          Aa = f.getCoordinate(cb);
        ia = sa.open;
        C = f.getCoordinate(V);
        ...
        var na = U.x[Fa.id],
          ta = Math.floor($ / 2),
          Na = ta;
        "start" == this.pointPosition && (na -= $ / 2,
          ta = 0,
          Na = $);
        Q || (F.x = na); - 1E5 > na && (na = -1E5);
        na > k + 1E5 && (na = k + 1E5);
        p ? (D = C,
          P = N,
          N = C = na,
          isNaN(ia) && !this.fillToGraph && (P = da),
          Ka = za,
          La = Aa) : (P = D = na,
          isNaN(ia) && !this.fillToGraph && (N = da));
        V < ia && (F.isNegative = !0,
          Ga && (wa = Ga),
          Ia && (Ma = Ia),
          void 0 != ya && (qa = ya));
        switch (g) {
          case "line":
            isNaN(V) ? s || (this.drawLineGraph(q, v, ea, fa),
              q = [],
              v = [],
              ea = [],
              fa = []) : (F.isNegative = V < ha ? !0 : !1,
              q.push(D),
              v.push(C),
              Z = D,
              ca = C,
              oa = D,
              pa = C, !Ja || (isNaN(N) || isNaN(P)) || (ea.push(P),
                fa.push(N)));
            break;
          case "smoothedLine":
            isNaN(V) ? s || (this.drawSmoothedGraph(q, v, ea, fa),
              q = [],
              v = [],
              ea = [],
              fa = []) : (F.isNegative = V < ha ? !0 : !1,
          ...
          case "step":
            isNaN(V) ? s || (t = NaN,
              ...
              p ? (isNaN(u) || (q.push(u),
                ...
                q.push(D),
                v.push(C + Na),
                q.push(D), !Ja || (isNaN(N) || isNaN(P)) || (ea.push(w),
                  fa.push(N - ta),
                  ea.push(P),
                  fa.push(N - ta),
                  ea.push(P),
                  fa.push(N + Na))) : (isNaN(t) || (v.push(t),
                  q.push(D - ta)),
                q.push(D - ta),
                v.push(C),
                q.push(D + Na),
                v.push(C), !Ja || (isNaN(N) || isNaN(P)) || (ea.push(P -
                    ta),
                  fa.push(y),
                  ea.push(P - ta),
                  fa.push(N),
          ...
          case "column":
            ja = qa;
            void 0 != F.lineColor && (ja = F.lineColor);
            if (!isNaN(V)) {
              V < ha ? (F.isNegative = !0,
                Ga && (wa = Ga),
                void 0 != ya && (ja = ya)) : F.isNegative = !1;
              var rb = f.min,
                sb = f.max;
              if (!(V < rb && ia < rb || V > sb && ia > sb))
                if (p) {
                  "3d" == E ? (M = C - 0.5 * (h + B) + B / 2 + H * T,
                    L = P + z * T) : (M = C - (r / 2 - T) * (h + B) + B /
                    2,
                    L = P);
                  J = h;
                  Z = D;
                  ...
                  if (M < l && 0 < J && (la = new AmCharts.Cuboid(e, aa,
                        J, z - a.d3x, H - a.d3y, wa, Ma, R, ja, W, G, n,
                        p),
                      "bottom" != I))
                    if (I = f.reversed ? "left" : "right",
                      0 > V)
                      I = f.reversed ? "right" : "left";
                    else if ("regular" == E || "100%" == E)
                    Z += this.dx
                } else {
                  "3d" == E ? (L = D - 0.5 * (h + B) + B / 2 + z * T,
                    M = N + H * T) : (L = D - (r / 2 - T) * (h + B) + B /
                    2,
                    M = N);
                  J = h;
                  Z = L + h / 2;
                  ...
                  if (L < k + T * z && 0 < J)
                    if (la = new AmCharts.Cuboid(e, J, aa, z - a.d3x, H -
                        a.d3y, wa, Ma, R, ja, this.lineAlpha, G, n, p),
                      0 > V && "middle" != I)
                      I = "bottom";
                    else if (I = ka,
                    "regular" == E || "100%" == E)
              ...
              if (la && (ra = la.set,
                  ra.translate(L, M),
                  this.columnsSet.push(ra), (F.url || this.showHandOnHover) &&
                  ra.setAttr("cursor", "pointer"), !Q)) {
                "none" == E && (A = p ? (this.end + 1 - O) * x - c : x *
                  O + c);
                "3d" == E && (p ? (A = (x - c) * (this.end + 1 - O),
                  Z += z * this.columnIndex,
                  oa += z * this.columnIndex,
                  F.y += z * this.columnIndex) : (A = (x - c) * (O +
                    1),
                  Z += 3,
                  ca += H * this.columnIndex + 7,
                  pa += H * this.columnIndex,
                  F.y += H * this.columnIndex));
                if ("regular" == E || "100%" == E)
                  I = "middle",
                  A = p ? 0 < sa.value ? (this.end + 1 - O) * x + c : (
                    this.end + 1 - O) * x - c : 0 < sa.value ? x * O + c :
                  x * O - c;
                ...
                this.animateColumns(la, O, D, P, C, N);
                this.addListeners(ra, F)
              }
            }
            break;
          case "candlestick":
              ...
              if (p) {
                if (M = C - h / 2,
                  ...
                  V > ia ? (fb = [D, La],
                    gb = [P, Ka]) : (fb = [P, La],
                    gb = [D, Ka]);
                  !isNaN(La) && !isNaN(Ka) && (C < l && 0 < C) && (Va =
                    AmCharts.line(e, fb, [C, C], ja, W, R),
                    eb = AmCharts.line(e, gb, [C, C], ja, W, R));
                  aa = D - P;
                  la = new AmCharts.Cuboid(e, aa, J, z, H, wa, Ha, R, ja,
                    W, G, n, p)
                }
              } else if (L = D - h / 2,
                M = N + R / 2,
                ...
                aa = C - N,
                L < k && 0 < J) {
                var la = new AmCharts.Cuboid(e, J, aa, z, H, wa, Ma, R,
                    ja, W, G, n, p),
                  hb, ib;
                V > ia ? (hb = [C, Aa],
                  ib = [N, za]) : (hb = [N, Aa],
                  ib = [C, za]);
                !isNaN(Aa) && !isNaN(za) && (D < k && 0 < D) && (Va =
                  AmCharts.line(e, [D, D], hb, ja, W, R),
                  eb = AmCharts.line(e, [D, D], ib, ja, W, R))
              }
              la && (ra = la.set,
                Y.push(ra),
                ra.translate(L, M - R / 2), (F.url || this.showHandOnHover) &&
                ra.setAttr("cursor", "pointer"),
                Va && (Y.push(Va),
                  Y.push(eb)),
                Z = D,
                ca = C,
          ...
          case "ohlc":
            if (!(isNaN(ia) || isNaN(cb) || isNaN(db) || isNaN(V))) {
              ...
              if (p) {
                ...
                kb = AmCharts.line(e, [P, P], [mb, tb], qa, W, R, X);
                0 < C && C < l && (jb = AmCharts.line(e, [Ka, La], [C, C],
                  qa, W, R, X));
                ...
                kb = AmCharts.line(e, [ob, ub], [N, N], qa, W, R, X);
                0 < D && D < k && (jb = AmCharts.line(e, [D, D], [za, Aa],
                  qa, W, R, X));
          ...
          if (this.end - this.start <= vb || 0 === vb) {
            ...
            if (wb) {
              ...
              switch (I) {
                ...
                case "bottom":
                  ...
                  break;
                case "middle":
                  "column" == g && (p ? (Ba = -(Xa / 2) + this.fontSize /
                    2,
                    xa = -(D - P) / 2 - z,
                    0 > aa && (xa += z),
                    Math.abs(D - P) < Wa && !this.showAllValueLabels &&
                    (ba.remove(),
                      ba = null)) : (Ba = -(C - N) / 2,
                    0 > aa && (Ba -= H),
                    Math.abs(C - N) < Xa && !this.showAllValueLabels &&
                    (ba.remove(),
                      ba = null)))
              }
              if (ba) {
            ...
            if ("column" == g && "regular" == E || "100%" == E) {
              ...
              if (zb) {
                ...
                Db && Db.remove();
                p ? (Pa = C,
                  Oa = 0 > V ? D - Bb / 2 - 2 : D + Bb / 2 + 3) : (Oa =
                  D,
                  Pa = 0 > V ? C + Cb / 2 : C - Cb / 2 - 3);
                Ea.translate(Oa, Pa);
                f.totals[O] = Ea;
                p ? (0 > Pa || Pa > l) && Ea.remove() : (0 > Oa || Oa > k) &&
                  Ea.remove()
              }
            }
          }
    ...
    if ("line" == g || "step" == g || "smoothedLine" == g)
      "smoothedLine" == g ? this.drawSmoothedGraph(q, v, ea, fa) : this.drawLineGraph(
        q, v, ea, fa),
      Q || this.launchAnimation();
    this.bulletsHidden && this.hideBullets()
  },
  animateColumns: function(a, b, c, d, e, f) {
    var g = this;
    c = g.chart.startDuration;
    0 < c && !g.animationPlayed && (g.seqAn ? (a.set.hide(),
      g.animationArray.push(a),
      a = setTimeout(function() {
        g.animate.call(g)
      }, 1E3 * c / (g.end - g.start + 1) * (b - g.start)),
      g.timeOuts.push(a)) : g.animate(a))
  },
  ...
  drawLineGraph: function(a, b, c, d) {
    ...
    if (1 < a.length) {
      ...
      r = AmCharts.line(g, a, b, r, l, m, p, !1, !0);
      h.push(r);
      h.click(function() {
        e.handleGraphClick()
      });
      void 0 !== s && (l = AmCharts.line(g, a, b, s, l, m, p, !1, !0),
        k.push(l));
      if (0 < f || 0 < v)
        if (l = a.join(";").split(";"),
          m = b.join(";").split(";"),
          "serial" == e.chartType && (0 < c.length ? (c.reverse(),
            d.reverse(),
            l = a.concat(c),
            m = b.concat(d)) : e.rotate ? (m.push(m[m.length - 1]),
            l.push(u),
            m.push(m[0]),
            l.push(u),
            m.push(m[0]),
            l.push(l[0])) : (l.push(l[l.length - 1]),
            m.push(u),
            l.push(l[0]),
            m.push(u),
            l.push(a[0]),
            m.push(m[0]))),
          0 < f && (a = AmCharts.polygon(g, l, m, n, f, 0, 0, 0, this.gradientRotation),
            h.push(a)),
          q || void 0 !== s)
          isNaN(v) && (v = f),
          q || (q = s),
          g = AmCharts.polygon(g, l, m, q, v, 0, 0, 0, this.gradientRotation),
          k.push(g),
          k.click(function() {
            e.handleGraphClick()
          });
  ...
  drawSmoothedGraph: function(a, b, c, d) {
    if (1 < a.length) {
      ...
      g.push(v.path);
      void 0 !== r && (k = new AmCharts.Bezier(f, a, b, r, k, l, p, 0, e),
        h.push(k.path));
      0 < m && (l = a.join(";").split(";"),
        v = b.join(";").split(";"),
        k = "",
        0 < c.length ? (c.reverse(),
          d.reverse(),
          l = a.concat(c),
          v = b.concat(d)) : (this.rotate ? (k += " L" + q + "," + b[b.length -
              1],
            k += " L" + q + "," + b[0]) : (k += " L" + a[a.length - 1] +
            "," + q,
            k += " L" + a[0] + "," + q),
          k += " L" + a[0] + "," + b[0]),
        c = new AmCharts.Bezier(f, l, v, NaN, 0, 0, p, m, e, k),
        g.push(c.path),
        n || void 0 !== r) && (s || (s = m),
        n || (n = r),
        a = new AmCharts.Bezier(f, a, b, NaN, 0, 0, n, s, e, k),
        h.push(a.path));
      this.applyMask(h, g)
    }
  },
  ...
  animateGraphs: function() {
    ...
    var f = a.startDuration,
      a = a.startEffect;
    b && (this.rotate ? (b.translate(-1E3, e),
        c.translate(-1E3, e)) : (b.translate(d, -1E3),
        c.translate(d, -1E3)),
      b.animate({
        opacity: 1,
        translate: d + "," + e
  ...
  legendKeyColor: function() {
    ...
    void 0 === a && (a = this.lineColor,
      0 === b && (b = this.fillColors) && (a = "object" == typeof b ? b[
        0] : b));
    return a
  },
  ...
  createBullet: function(a, b, c, d) {
    ...
    if ("none" != this.bullet || a.bullet) {
      ...
      switch (e) {
        case "round":
          h = AmCharts.circle(d, f / 2, p, r, g, l, m);
          break;
        case "square":
          h = AmCharts.polygon(d, [0, f, f, 0], [0, 0, f, f], p, r, g, l,
            m);
          b -= f / 2;
          c -= f / 2;
          k = -f / 2;
          break;
        case "triangleUp":
          h = AmCharts.triangle(d, f, 0, p, r, g, l, m);
          break;
        case "triangleDown":
          h = AmCharts.triangle(d, f, 180, p, r, g, l, m);
          break;
        case "triangleLeft":
          h = AmCharts.triangle(d, f, 270, p, r, g, l, m);
          break;
        case "triangleRight":
          h = AmCharts.triangle(d, f, 90, p, r, g, l, m);
          break;
        case "bubble":
          h = AmCharts.circle(d, f / 2, p, r, g, l, m, !0)
      }
    }
    g = e = 0;
    if (this.customBullet || a.customBullet)
      ...
      l && (h && h.remove(),
        "function" == typeof l ? (h = new l,
          h.chart = this.chart,
          a.bulletConfig && (h.availableSpace = c,
            h.graph = this,
            a.bulletConfig.minCoord = this.minCoord - c,
            h.bulletConfig = a.bulletConfig),
          h.write(d),
          h = h.set) : (this.chart.path && (l = this.chart.path + l),
          h = d.image(l, 0, 0, f, f),
          this.centerCustomBullets && (b -= f / 2,
            c -= f / 2,
            e -= f / 2,
            g -= f / 2)));
    h && ((a.url || this.showHandOnHover) && h.setAttr("cursor",
        "pointer"),
      "serial" == this.chartType && (b - e < k || b - e > this.width ||
        c < -f / 2 || c - g > this.height) && (h.remove(),
        h = null),
      h && (this.bulletSet.push(h),
        h.translate(b, c),
        this.addListeners(h, a),
  ...
  handleRollOver: function(a) {
    if (a) {
      ...
      c = this.showBalloon;
      b.chartCursor && "serial" == this.chartType && (c = !1, !b.chartCursor
        .valueBalloonsEnabled && this.showBalloon && (c = !0));
      if (c) {
  ...
  handleRightClick: function(a) {
    a && (a = {
      ...
      this.fire("rightClickGraphItem", a),
      this.chart.fire("rightClickGraphItem", a))
  },
...
AmCharts.ChartCursor = AmCharts.Class({
  ...
  createCursor: function() {
    ...
    a ? (h = [0, n, n + l],
      k = [0, 0, m]) : (h = [l, 0, 0],
      k = [m, 0, s]);
    this.line = b = AmCharts.line(this.container, h, k, this.cursorColor,
      b, 1);
    this.set.push(b);
    a ? (e && (g.pointerWidth = 0),
      "right" == d ? e ? g.setBounds(p, r + m, p + n + l, r + s + m) :
      g.setBounds(p + n + l + f, r + m, p + n + 1E3, r + s + m) : e ? g
      .setBounds(p, r, n + p, s + r) : g.setBounds(-1E3, -1E3, p - q -
        f, r + s + 15)) : (g.maxWidth = n,
      c.parseDates && (q = 0,
        g.pointerWidth = 0),
      "top" == d ? e ? g.setBounds(p + l, r + m, n + l + p, s + r) : g.setBounds(
        p + l, -1E3, n + l + p, r + m - q - f) : e ? g.setBounds(p, r,
        n + p, s + r - q) : g.setBounds(p, r + s + q + f - 1, p + n, r +
        s + q + f));
    this.hideCursor()
  },
  createCrosshair: function() {
    var a = this.cursorAlpha,
      b = this.container,
      c = AmCharts.line(b, [0, 0], [0, this.height], this.cursorColor, a,
        1),
      a = AmCharts.line(b, [0, this.width], [0, 0], this.cursorColor, a,
        1);
    this.set.push(c);
    this.set.push(a);
    this.vLine = c;
  ...
  detectMovement: function() {
    ...
    if (a.mouseIsOver) {
      var b = a.mouseX - this.x,
        c = a.mouseY - this.y;
      0 < b && b < this.width && 0 < c && c < this.height ? (this.drawing ?
        this.rolledOver || a.setMouseCursor("crosshair") : this.pan &&
        (this.rolledOver || a.setMouseCursor("move")),
        this.rolledOver = !0,
  ...
  updateCrosshair: function() {
    ...
    0 < this.cursorAlpha && (d.show(),
      e.show(),
      d.translate(b, 0),
      e.translate(0, c));
    this.zooming && (a.hideXScrollbar && (b = NaN),
      a.hideYScrollbar && (c = NaN),
  ...
  updateSelectionSize: function(a, b) {
    ...
    isNaN(b) || (d > b && (f = b,
      ...
      d == b && (f = b,
        h = 0));
    0 < g && 0 < h && (c = AmCharts.rect(this.container, g, h, this.cursorColor,
        this.selectionAlpha),
  ...
  arrangeBalloons2: function() {
    ...
    for (e = 0; e < a.length; e++) {
      ...
      0 < e && b - g < d + 3 && (f.setBounds(c, d + 3, c + this.width, d +
          g + 3),
        f.draw());
      f.set && f.set.show();
      d = f.bottom
    ...
    for (c = 0; c < b.length; c++) {
      ...
      if (!d.hidden && d.balloonText) {
        ...
        if (!isNaN(f)) {
          ...
          this.rotate ? (h = f,
            f = g) : h = g;
          d = AmCharts.circle(a, this.bulletSize / 2, this.chart.getBalloonColor(
            d, e), d.cursorBulletAlpha);
          d.translate(h, f);
  ...
  zoom: function(a, b, c, d) {
    ...
    this.zooming = !1;
    var f;
    this.rotate ? this.selectionPosY = f = e.mouseY : this.selectionPosX =
      f = e.mouseX;
    this.start = a;
    this.end = b;
    this.startTime = c;
    ...
    f = this.width;
    var h = this.height;
    g.parseDates && !g.equalSpacing ? (a = d - c + g.minDuration(),
      a = e ? h / a : f / a) : a = e ? h / (b - a) : f / (b - a);
    this.stepWidth = a;
    this.setPosition();
    this.hideCursor()
  },
  ...
  setPosition: function(a, b) {
    ...
    if ("cursor" == this.type) {
      if (AmCharts.ifArray(this.data)) {
        ...
        if ((a != this.previousMousePosition || !0 === this.zoomed ||
            this.oneBalloonOnly) && !isNaN(a)) {
          var c = this.chart.categoryAxis.xToIndex(a);
          if (c != this.previousIndex || this.zoomed || "mouse" == this.cursorPosition ||
            this.oneBalloonOnly)
            this.updateCursor(c, b),
            this.zoomed = !1
        }
  ...
  updateCursor: function(a, b) {
    ...
    this.drawingNow && (AmCharts.remove(this.drawingLine),
      this.drawingLine = AmCharts.line(this.container, [this.x + this.drawStartX,
          this.x + d
        ], [this.y + this.drawStartY, this.y + e], this.cursorColor, 1,
        1));
    if (this.enabled) {
      void 0 === b && (b = !0);
      this.index = a;
        ...
        if (c.mouseIsOver || A || z || this.forceShow)
          if (this.forceShow = !1,
            ...
            0 !== d && (g = {
              ...
              g.chart = this.chart,
              f.parseDates && !f.equalSpacing ? (c + d > w && (d = w -
                  c),
                A + d < t && (d = t - A),
                g.start = A + d,
                g.end = c + d,
                this.fire(g.type, g)) : I + d >= this.data.length || 0 >
              k + d || (g.start = k + d,
                g.end = I + d,
                this.fire(g.type, g)))
          } else {
            "start" == y && (n -= f.cellWidth / 2);
            "mouse" == y && c.mouseIsOver && (n = s ? e - 2 : d - 2);
            if (s) {
              if (0 > n)
                if (A)
                  n = 0;
            ...
            0 < this.cursorAlpha && (t = this.line,
              s ? t.translate(0, n + h) : t.translate(n, 0),
              t.show());
            this.linePos = s ? n + h : n;
            A && (s ? this.updateSelectionSize(NaN, n) : this.updateSelectionSize(
              n, NaN));
            t = !0;
            A && (t = !1);
            this.categoryBalloonEnabled && t ? (s ? (q && ("right" == x ?
                  u.setBounds(k, l + h, k + m + g, l + n + h) : u.setBounds(
                    k, l + h, k + m + g, l + n)),
                "right" == x ? q ? u.setPosition(k + m + g, l + n + h) :
                u.setPosition(k + m + g + E, l + n + h) : q ? u.setPosition(
                  k, l + n) : u.setPosition(k - E, l + n)) : "top" == x ?
              q ? u.setPosition(k + n + g, l + h) : u.setPosition(k + n +
                g, l + h - E + 1) : q ? u.setPosition(k + n, l + p) : u
              .setPosition(k + n, l + p + E - 1), (w = this.categoryBalloonFunction) ?
              u.showBalloon(w(r.category)) : f.parseDates ? (f =
                AmCharts.formatDate(r.category, this.categoryBalloonDateFormat), -
                1 != f.indexOf("fff") && (f = AmCharts.formatMilliseconds(
                  f, r.category)),
                u.showBalloon(f)) : u.showBalloon(r.category)) : u.hide();
              ...
              if (this.oneBalloonOnly) {
                ...
                for (f = 0; f < H.length; f++)
                  ...
                  w.showBalloon && (!w.hidden && w.balloonText) && (v = r
                    .axes[w.valueAxis.id].graphs[w.id],
                    u = v.y,
                    isNaN(u) || (s ? Math.abs(d - u) < h && (h = Math.abs(
                        d - u),
                      I = w) : Math.abs(e - u) < h && (h = Math.abs(e -
                        u),
                      I = w)));
                this.mostCloseGraph && (I = this.mostCloseGraph)
              }
              for (f = 0; f < H.length; f++)
                if (w = H[f], (!this.oneBalloonOnly || w == I) && (w.showBalloon &&
                    !w.hidden && w.balloonText) && (v = r.axes[w.valueAxis
                      .id].graphs[w.id],
                    u = v.y, !isNaN(u))) {
                  q = v.x;
                  n = !0;
                  if (s) {
                    ...
                    n = !1;
                  n && (n = w.valueBalloon,
                    x = c.getBalloonColor(w, v),
                    n.setBounds(k, l, k + m, l + p),
                    n.pointerOrientation = "H",
                    n.changeColor(x),
                    void 0 !== w.balloonAlpha && (n.fillAlpha = w.balloonAlpha),
                    void 0 !== w.balloonTextColor && (n.color = w.balloonTextColor),
                    n.setPosition(h + k, q + l),
                    h = c.formatString(w.balloonText, v, w), (q = w.balloonFunction) &&
                    (h = q(v, w)),
                    "" !== h && n.showBalloon(h), !s && n.set && n.set.hide(),
                    t.push({
                      yy: u,
                      balloon: n
                    }))
    ...
    if (a) {
      ...
      if (this.enabled && 0 < b.length) {
        if (this.pan)
          ...
          c.chart = a;
          if ("cursor" == this.type)
            this.rotate ? this.selectionPosY = e : this.selectionPosX = e =
            d,
            2 > Math.abs(e - this.initialMouse) && this.fromIndex == this
            .index || (this.index < this.fromIndex ? (c.end = this.fromIndex,
                c.start = this.index) : (c.end = this.index,
                c.start = this.fromIndex),
              e = a.categoryAxis,
              e.parseDates && !e.equalSpacing && (c.start = b[c.start].time,
                c.end = a.getEndTime(b[c.end].time)),
              this.skipZoomDispatch || this.fire(c.type, c));
          else {
            var g = this.initialMouseX,
              h = this.initialMouseY;
            3 > Math.abs(d - g) && 3 > Math.abs(e - h) || (b = Math.min(g,
                d),
              f = Math.min(h, e),
              d = Math.abs(g - d),
              e = Math.abs(h - e),
  ...
  handleMouseDown: function(a) {
    if (this.zoomable || this.pan || this.drawing) {
      var b = this.rotate,
        ...
        d = c.mouseX - this.x,
        e = c.mouseY - this.y;
      if (0 < d && d < this.width && 0 < e && e < this.height || "fake" ==
        a)
        this.setPosition(),
        this.selectWithoutZooming && AmCharts.remove(this.selection),
        this.drawing ? (this.drawStartY = e,
          this.drawStartX = d,
          ...
          this.panClickEndTime = this.endTime) : this.zoomable && (
          "cursor" == this.type ? (this.fromIndex = this.index,
            b ? (this.initialMouse = e,
              this.selectionPosY = this.linePos) : (this.initialMouse = d,
              this.selectionPosX = this.linePos)) : (this.initialMouseX =
            d,
            this.initialMouseY = e,
            this.selectionPosX = d,
            this.selectionPosY = e),
          this.zooming = !0)
    }
  }
});
AmCharts.SimpleChartScrollbar = AmCharts.Class({
  ...
  draw: function() {
    ...
    c ? (f = a.scrollbarHeight,
      g = d.plotAreaHeight) : (g = a.scrollbarHeight,
      f = d.plotAreaWidth);
    a.width = f;
    if ((a.height = g) && f) {
      ...
      c ? (h = f + "dragIconH.gif",
        f = a.dragIconWidth,
        c = a.dragIconHeight) : (h = f + "dragIcon.gif",
        c = a.dragIconWidth,
        f = a.dragIconHeight);
      g = b.image(h, 0, 0, c, f);
  ...
  updateScrollbar: function() {
    ...
    m.mouseIsOver && (this.dragging && (m = this.initialCoord,
        l ? (a = m + (s - a),
          ...
          m = r - h,
          a > m && (a = m),
          g.setAttr("y", a)) : (a = m + (n - a),
          0 > a && (a = 0),
          m = p - k,
          a > m && (a = m),
          g.setAttr("x", a))),
      this.resizingRight && (l ? (a = s - d,
        a + d > r + f && (a = r - d + f),
        0 > a ? (this.resizingRight = !1,
          b = this.resizingLeft = !0) : (0 === a && (a = 0.1),
          g.setAttr("height", a))) : (a = n - c,
        a + c > p + e && (a = p - c + e),
        0 > a ? (this.resizingRight = !1,
          b = this.resizingLeft = !0) : (0 === a && (a = 0.1),
          g.setAttr("width", a)))),
      this.resizingLeft && (l ? (c = d,
        d = s,
        d < f && (d = f),
        d > r + f && (d = r + f),
        a = !0 === b ? c - d : h + c - d,
        0 > a ? (this.resizingRight = !0,
          this.resizingLeft = !1,
          g.setAttr("y", c + h - f)) : (0 === a && (a = 0.1),
          g.setAttr("y", d - f),
          g.setAttr("height", a))) : (d = n,
        d < e && (d = e),
        d > p + e && (d = p + e),
        a = !0 === b ? c - d : k + c - d,
        0 > a ? (this.resizingRight = !0,
          this.resizingLeft = !1,
          g.setAttr("x", c + k - e)) : (0 === a && (a = 0.1),
          g.setAttr("x", d - e),
          g.setAttr("width", a)))),
      this.clipDragger(!0))
  },
  clipDragger: function(a) {
    ...
    if (this.rotate) {
      ...
      b = this.height + 1,
      this.clipX != c || this.clipW != e)
      f = !0;
    f && (this.clipAndUpdate(c, d, e, b),
  ...
  dispatchScrollbarEvent: function() {
    if (this.skipEvent)
      ...
      var b = this.getDBox(),
        ...
        b = b.height;
      this.rotate ? (c = d,
        e = this.height / b) : e = this.width / e;
      a = {
        type: "zoomed",
        position: c,
        chart: a,
  ...
  updateDragIconPositions: function() {
    ...
    this.rotate ? (f = this.dragIconWidth,
      ...
      d.translate((h - g) / 2, c - f / 2),
      e.translate((h - g) / 2, c + a.height - f / 2)) : (f = this.dragIconHeight,
      g = this.dragIconWidth,
      d.translate(b - g / 2, (h - f) / 2),
      e.translate(b + -g / 2 + a.width, (h - f) / 2))
  },
  ...
  hideDragIcons: function() {
    this.resizingLeft || (this.resizingRight || this.dragging) || (this.hideResizeGrips &&
      (this.iconLeft.hide(),
        this.iconRight.hide()),
      this.removeCursors())
  },
  ...
  relativeZoom: function(a, b) {
    ...
    this.multiplier = a;
    this.position = b;
    this.updateScrollbarSize(b, this.rotate ? b + this.height / a : b +
      this.width / a)
  },
  destroy: function() {
    this.clear();
  ...
  iconRollOver: function() {
    this.rotate ? this.chart.setMouseCursor("n-resize") : this.chart.setMouseCursor(
      "e-resize");
    this.handleMouseOver()
  },
  getDBox: function() {
  ...
  handleBgClick: function() {
    if (!this.resizingRight && !this.resizingLeft) {
      ...
      k ? (a = "y",
        b = b.mouseY - e / 2 - g,
        b = AmCharts.fitToBounds(b, 0, this.height - e)) : (a = "x",
        b = b.mouseX - f / 2 - h,
        b = AmCharts.fitToBounds(b, 0, this.width - f));
  ...
  handleReleaseOutside: function() {
    if (this.set) {
      if (this.resizingLeft || this.resizingRight || this.dragging)
        this.updateOnRelease(),
        this.removeCursors();
      this.mouseIsOver = this.dragging = this.resizingRight = this.resizingLeft = !
        1;
      this.hideDragIcons();
      this.updateScrollbar()
    }
...
AmCharts.ChartScrollbar = AmCharts.Class({
  ...
  draw: function() {
    ...
    if (l = a.graph) {
      ...
      Infinity != f && (p.minimum = f); - Infinity != g && (p.maximum = g +
        0.1 * (g - f));
      f == g && (p.minimum -= 1,
        p.maximum += 1);
    ...
    if (this.skipEvent)
      ...
      if (f.parseDates && !f.equalSpacing) {
        if (a = d.firstTime,
          f.minDuration(),
          d = Math.round(b / g) + a,
          a = this.dragging ? d + this.timeDifference : Math.round((b + c) /
            g) + a,
          d > a && (d = a),
          d != this.startTime || a != this.endTime)
          this.startTime = d,
          this.endTime = a,
          e.start = d,
          e.end = a,
          ...
          this.fire(e.type, e)
      } else if (f.startOnAxis || (b += g / 2),
        c -= this.stepWidth / 2,
        d = f.xToIndex(b),
        b = f.xToIndex(b + c),
        d != this.start || this.end != b)
        f.startOnAxis && (this.resizingRight && d == b && b++,
          this.resizingLeft && d == b && (0 < d ? d-- : b = 1)),
        this.start = d,
        this.end = this.dragging ? this.start + this.difference : b,
        e.start = this.start,
        e.end = this.end,
        f.parseDates && (a[this.start] && (e.startDate = new Date(a[this.start]
            .time)),
          a[this.end] && (e.endDate = new Date(a[this.end].time))),
        this.fire(e.type, e)
    }
  },
  zoomScrollbar: function() {
...
AmCharts.text = function(a, b, c, d, e, f, g, h) {
  f || (f = "middle");
  "right" == f && (f = "end");
  AmCharts.isIE && 9 > AmCharts.IEversion && (b = b.replace("&amp;", "&"),
    b = b.replace("&", "&amp;"));
  c = {
    fill: c,
    "font-family": d,
...
AmCharts.triangle = function(a, b, c, d, e, f, g, h) {
  ...
  b /= 2;
  var k;
  0 === c && (k = " M" + -b + "," + b + " L0," + -b + " L" + b + "," + b +
    " Z");
  180 == c && (k = " M" + -b + "," + -b + " L0," + b + " L" + b + "," + -b +
    " Z");
  90 == c && (k = " M" + -b + "," + -b + " L" + b + ",0 L" + -b + "," + b +
    " Z");
  270 == c && (k = " M" + -b + ",0 L" + b + "," + b + " L" + b + "," + -b +
    " Z");
...
AmCharts.wedge = function(a, b, c, d, e, f, g, h, k, l, m) {
  ...
  var r = p(g / f * h),
    n = AmCharts.VML,
    s = -359.5 - f / 100; - 359.94 > s && (s = -359.94);
  e <= s && (e = s);
  var q = 1 / 180 * Math.PI,
    s = b + Math.cos(d * q) * h,
    v = c + Math.sin(-d * q) * r,
  ...
  n && (s = p(10 * s),
    ...
    h *= 10,
    r *= 10,
    1 > Math.abs(e) && (1 >= Math.abs(w - u) && 1 >= Math.abs(y - t)) && (H = !
      0));
  e = "";
  if (0 < k) {
    n ? (path = " M" + s + "," + (v + k) + " L" + u + "," + (t + k),
      H || (path += " A" + (b - f) + "," + (k + c - g) + "," + (b + f) +
        "," + (k + c + g) + "," + u + "," + (t + k) + "," + w + "," + (y +
          k)),
      path += " L" + x + "," + (q + k),
      0 < h && (H || (path += " B" + (b - h) + "," + (k + c - r) + "," + (b +
          h) + "," + (k + c + r) + "," + x + "," + (k + q) + "," + s +
        "," + (k + v)))) : (path = " M" + s + "," + (v + k) + " L" + u +
      "," + (t + k),
      path += " A" + f + "," + g + ",0," + z + ",1," + w + "," + (y + k) +
      " L" + x + "," + (q + k),
      0 < h && (path += " A" + h + "," + r + ",0," + z + ",0," + s + "," +
        (v + k)));
    path += " Z";
    var E = a.path(path, void 0, void 0, "1000,1000").attr(A);
    d.push(E);
    E = a.path(" M" + s + "," + v + " L" + s + "," + (v + k) + " L" + u + "," +
      (t + k) + " L" + u + "," + t + " L" + s + "," + v + " Z", void 0,
      void 0, "1000,1000").attr(A);
    k = a.path(" M" + w + "," + y + " L" + w + "," + (y + k) + " L" + x + "," +
      (q + k) + " L" + x + "," + q + " L" + w + "," + y + " Z", void 0,
      void 0, "1000,1000").attr(A);
    d.push(E);
    d.push(k)
  }
  n ? (H || (e = " A" + p(b - f) + "," + p(c - g) + "," + p(b + f) + "," + p(
        c + g) + "," + p(u) + "," + p(t) + "," + p(w) + "," + p(y)),
      f = " M" + p(s) + "," + p(v) + " L" + p(u) + "," + p(t) + e + " L" + p(
        x) + "," + p(q)) : f = " M" + s + "," + v + " L" + u + "," + t + (
      " A" + f + "," + g + ",0," + z + ",1," + w + "," + y) + " L" + x + "," +
    q;
  0 < h && (n ? H || (f += " B" + (b - h) + "," + (c - r) + "," + (b + h) +
      "," + (c + r) + "," + x + "," + q + "," + s + "," + v) : f += " A" +
    h + "," + r + ",0," + z + ",0," + s + "," + v);
...
AmCharts.adjustLuminosity = function(a, b) {
  ...
  6 > a.length && (a = String(a[0]) + String(a[0]) + String(a[1]) + String(a[
    1]) + String(a[2]) + String(a[2]));
  b = b || 0;
  var c = "#",
    d, e;
  for (e = 0; 3 > e; e++)
...
AmCharts.AmPieChart = AmCharts.Class({
  inherits: AmCharts.AmChart,
  construct: function() {
    this.createEvents("rollOverSlice", "rollOutSlice", "clickSlice",
      "pullOutSlice", "pullInSlice", "rightClickSlice");
    AmCharts.AmPieChart.base.construct.call(this);
    this.colors =
      "#FF0F00 #FF6600 #FF9E01 #FCD202 #F8FF01 #B0DE09 #04D215 #0D8ECF #0D52D1 #2A0CD0 #8A0CCF #CD0D74 #754DEB #DDDDDD #999999 #333333 #000000 #57032A #CA9726 #990000 #4B0C25"
      .split(" ");
    this.pieAlpha = 1;
  ...
  drawChart: function() {
    ...
    if (AmCharts.ifArray(b)) {
      if (0 < a.realWidth && 0 < a.realHeight) {
        ...
        a.chartDataLabels = [];
        a.ticks = [];
        var p, r, n, s = AmCharts.toNumber(a.labelRadius),
          q = a.measureMaxLabel();
        ...
        n || (e = 0 <= s ? e - h - k - 2 * q : e - h - k,
          f = f - l - m,
          n = Math.min(e, f),
          f < e && (n /= 1 - a.angle / 90,
            n > e && (n = e)),
          a.pullOutRadiusReal = AmCharts.toCoordinate(a.pullOutRadius,
            n),
          n = 0 <= s ? n - 1.8 * (s + a.pullOutRadiusReal) : n - 1.8 *
          a.pullOutRadiusReal,
          n /= 2);
        ...
        for (m = 0; m < b.length; m++)
          if (e = b[m], !0 !== e.hidden && 0 < e.percents) {
            ...
            h = AmCharts.wedge(d, p, r, f, k, n, l, g, a.depth3D, h, a.gradientRatio);
            ...
            if (a.labelsEnabled && a.labelText && e.percents >= a.hideLabelsPercent) {
              ...
              var t = a.formatString(a.labelText, e),
                x = e.labelColor;
              void 0 == x && (x = a.color);
              t = AmCharts.text(d, t, x, a.fontFamily, a.fontSize, w);
              t.translate(q + 1.5 * u, v);
              e.tx = q + 1.5 * u;
              e.ty = v;
  ...
  setDepths: function() {
    ...
    for (b = 0; b < a.length; b++) {
      var c = a[b],
        d = c.wedge,
        c = c.startAngle;
      90 >= c && 0 <= c || 360 >= c && 270 < c ? d.toFront() : (270 >= c &&
        180 < c || 180 >= c && 90 < c) && d.toBack()
    }
  },
  addEventListeners: function(a, b) {
    var c = this;
  ...
  formatString: function(a, b) {
    a = AmCharts.formatValue(a, b, ["value"], this.numberFormatter, "",
    ...
    for (b = 0; b < a.length; b++)
      if (this.chartDataLabels[b]) {
        var c = a[b],
          d = c.ty,
          e = this.radiusReal,
          d = AmCharts.line(this.container, [this.pieXReal + c.ix * e, c.tx,
              c.tx2
            ], [this.pieYReal + c.iy * e, d, d], this.labelTickColor,
            this.labelTickAlpha);
        c.wedge.push(d);
        this.ticks[b] = d
      }
  ...
  arrangeLabels: function() {
    ...
    for (d = b - 1; 0 <= d; d--)
      c = a[d],
      0 !== c.labelQuarter || c.hidden || this.checkOverlapping(d, c, 0, !
        0, 0);
    for (d = 0; d < b; d++)
      c = a[d],
      1 != c.labelQuarter || c.hidden || this.checkOverlapping(d, c, 1, !
        1, 0);
    for (d = b - 1; 0 <= d; d--)
      c = a[d],
      2 != c.labelQuarter || c.hidden || this.checkOverlapping(d, c, 2, !
        0, 0);
    for (d = 0; d < b; d++)
      c = a[d],
      3 != c.labelQuarter || c.hidden || this.checkOverlapping(d, c, 3, !
        1, 0)
  },
  checkOverlapping: function(a, b, c, d, e) {
    ...
    if (l) {
      if (!0 === d)
        for (g = a + 1; g < k; g++)
          (f = this.checkOverlappingReal(b, h[g], c)) && (g = k);
      else
        for (g = a - 1; 0 <= g; g--)
          (f = this.checkOverlappingReal(b, h[g], c)) && (g = 0);
      !0 === f && 100 > e && (f = b.ty + 3 * b.iy,
        b.ty = f,
        l.translate(b.tx2, f),
        this.checkOverlapping(a, b, c, d, e + 1))
    }
  },
  checkOverlappingReal: function(a, b, c) {
    var d = !1,
      e = a.label,
      f = b.label;
    a.labelQuarter != c || (a.hidden || b.hidden || !f) || (e = e.getBBox(),
      c = {},
      c.width = e.width,
      c.height = e.height,
      c.y = a.ty,
      ...
      f.y = b.ty,
      f.x = b.tx,
      AmCharts.hitTest(c, f) && (d = !0));
    return d
  },
  startSlices: function() {
    var a;
    for (a = 0; a < this.chartData.length; a++)
      0 < this.startDuration && this.sequencedAnimation ? this.setStartTO(
        a) : this.startSlice(this.chartData[a])
  },
  ...
  rollOverSlice: function(a, b) {
    ...
    var c = this.innerRadiusReal + (this.radiusReal - this.innerRadiusReal) /
      2;
  ...
  parseData: function() {
    ...
    if (void 0 !== b) {
      ...
      for (e = 0; e < c; e++) {
        ...
        f.visibleInLegend = AmCharts.toBoolean(h[this.visibleInLegendField], !
          0);
        g = h[this.alphaField];
      ...
      for (e = 0; e < a.length; e++)
        this.pieBaseColor ? g = AmCharts.adjustLuminosity(this.pieBaseColor,
          e * this.pieBrightnessStep / 100) : (g = this.colors[e],
          void 0 === g && (g = AmCharts.randomColor())),
  ...
  measureMaxLabel: function() {
    ...
    for (c = 0; c < a.length; c++) {
      var d = this.formatString(this.labelText, a[c]),
        d = AmCharts.text(this.container, d, this.color, this.fontFamily,
          this.fontSize),
        e = d.getBBox().width;
      e > b && (b = e);
      d.remove()
...
AmCharts.AmXYChart = AmCharts.Class({
  ...
  createValueAxes: function() {
    ...
    0 === b.length && (d = new AmCharts.ValueAxis,
      d.rotate = !1,
      d.setOrientation(!1),
      c.push(d),
      b.push(d));
    0 === a.length && (d = new AmCharts.ValueAxis,
      d.rotate = !0,
      d.setOrientation(!0),
      c.push(d),
      a.push(d));
  ...
  cleanChart: function() {
    AmCharts.callMethod("destroy", [this.valueAxes, this.graphs, this.scrollbarV,
      this.scrollbarH, this.chartCursor
    ])
  },
  zoomChart: function() {
  ...
  toggleZoomOutButton: function() {
    1 == this.heightMultiplier && 1 == this.widthMultiplier ? this.showZB(!
      1) : this.showZB(!0)
  },
  dispatchAxisZoom: function() {
    ...
    for (b = 0; b < a.length; b++) {
      ...
      if (!isNaN(c.min) && !isNaN(c.max)) {
        var d, e;
        "V" == c.orientation ? (d = c.coordinateToValue(-this.verticalPosition),
          e = c.coordinateToValue(-this.verticalPosition + this.plotAreaHeight)
        ) : (d = c.coordinateToValue(-this.horizontalPosition),
          e = c.coordinateToValue(-this.horizontalPosition + this.plotAreaWidth)
        );
        if (!isNaN(d) && !isNaN(e)) {
          if (d > e) {
            var f = e;
  ...
  formatString: function(a, b) {
    ...
    c || (c = this.numberFormatter);
    a = AmCharts.formatValue(a, b.values, ["value", "x", "y"], c); - 1 !=
      a.indexOf("[[") && (a = AmCharts.formatDataContextValue(a, b.dataContext));
    return a = AmCharts.AmSerialChart.base.formatString.call(this, a, b)
  },
  addChartScrollbar: function(a) {
    AmCharts.callMethod("destroy", [this.chartScrollbar, this.scrollbarH,
      this.scrollbarV
    ]);
    if (a) {
      this.chartScrollbar = a;
      ...
      this.hideXScrollbar || (c = new AmCharts.SimpleChartScrollbar,
        c.skipEvent = !0,
        c.chart = this,
  ...
  zoomScrollbars: function() {
    var a = this.scrollbarH;
    a && a.relativeZoom(this.widthMultiplier, -this.horizontalPosition /
      this.widthMultiplier);
    (a = this.scrollbarV) && a.relativeZoom(this.heightMultiplier, -this.verticalPosition /
  ...
  handleCursorZoom: function(a) {
    ...
    this.horizontalPosition = (this.horizontalPosition - a.selectionX) *
      b / this.widthMultiplier;
    this.verticalPosition = (this.verticalPosition - a.selectionY) * c /
      this.heightMultiplier;
    this.widthMultiplier = b;
...
AmCharts.AmDraw = AmCharts.Class({
  construct: function(a, b, c) {
    ...
    AmCharts.hasSVG = !!document.createElementNS && !!document.createElementNS(
      AmCharts.SVG_NS, "svg").createSVGRect;
    1 > b && (b = 10);
    1 > c && (c = 10);
    this.div = a;
    this.width = b;
    ...
    if (AmCharts.hasSVG) {
      ...
      d.style.width = b + "px";
      d.style.height = c + "px";
      AmCharts.rtl && (d.setAttribute("direction", "rtl"),
        d.style.left = "auto",
        d.style.right = "0px");
      ...
      AmCharts.isIE && AmCharts.VMLRenderer && (AmCharts.VML = !0,
        AmCharts.vmlStyleSheet || (document.namespaces.add("amvml",
  ...
  rect: function(a, b, c, d, e, f, g) {
    ...
    AmCharts.VML && (e = 100 * e / Math.min(c, d),
      c += 2 * f,
      d += 2 * f,
      h.bw = f,
  ...
  bounce: function(a, b, c, d, e) {
    return (b /= e) < 1 / 2.75 ? d * 7.5625 * b * b + c : b < 2 / 2.75 ?
      d * (7.5625 * (b -= 1.5 / 2.75) * b + 0.75) + c : b < 2.5 / 2.75 ?
      d * (7.5625 * (b -= 2.25 / 2.75) * b + 0.9375) + c : d * (7.5625 *
        (b -= 2.625 / 2.75) * b + 0.984375) + c
  },
  ...
  easeOutElastic: function(a, b, c, d, e) {
    ...
    return g * Math.pow(2, -10 * b) * Math.sin((b * e - a) * 2 * Math.PI /
      f) + d + c
  },
  renderFix: function() {
    var a = this.container,
...
AmCharts.AmDObject = AmCharts.Class({
  ...
  contextmenu: function(a) {
    this.node.addEventListener ? this.node.addEventListener("contextmenu",
      a, !0) : this.R.addListener(this, "contextmenu", a);
    return this
  },
  stop: function(a) {
    (a = this.animationX) && AmCharts.removeFromArray(this.R.animations,
      a);
...
AmCharts.VMLRenderer = AmCharts.Class({
  ...
  setAttr: function(a, b, c) {
    if (void 0 !== c) {
      ...
      "text" == f && ("text-anchor" == b && (a.anchor = c,
          h = e.clientWidth,
          "end" == c && (g.marginLeft = -h + "px"),
          "middle" == c && (g.marginLeft = -(h / 2) + "px",
            g.textAlign = "center"),
      ...
      if (g = a.children)
        for (h = 0; h < g.length; h++)
          g[h].setAttr(b, c);
      if ("shape" == f) {
        "cs" == b && (e.style.width = "100px",
          e.style.height = "100px",
          e.setAttribute("coordsize", c));
        "d" == b && e.setAttribute("path", this.svgPathToVml(c));
        "dd" == b && e.setAttribute("path", c);
        f = a.stroke;
        a = a.fill;
        "stroke" == b && (d ? f.color = c : f.setAttribute("color", c));
        "stroke-width" == b && (d ? f.weight = c : f.setAttribute(
          "weight", c));
        "stroke-opacity" == b && (d ? f.opacity = c : f.setAttribute(
          "opacity", c));
        "stroke-dasharray" == b && (g = "solid",
          0 < c && 3 > c && (g = "dot"),
          3 <= c && 6 >= c && (g = "dash"),
          6 < c && (g = "longdash"),
          d ? f.dashstyle = g : f.setAttribute("dashstyle", g));
        if ("fill-opacity" == b || "opacity" == b)
          0 === c ? d ? a.on = !1 : a.setAttribute("on", !1) : d ? a.opacity =
          c : a.setAttribute("opacity", c);
        "fill" == b && (d ? a.color = c : a.setAttribute("color", c));
        "rx" == b && (d ? e.arcSize = c + "%" : e.setAttribute("arcsize",
          c + "%"))
      }
    }
  },
  ...
  move: function(a, b, c) {
    ...
    "oval" == a.shapeType && (b -= AmCharts.removePx(e.width) / 2,
      c -= AmCharts.removePx(e.height) / 2);
    a = a.bw;
    isNaN(a) || (b -= a,
      c -= a);
    isNaN(b) || isNaN(c) || (d.style.left = b + "px",
      d.style.top = c + "px")
  },
  ...
  clipRect: function(a, b, c, d, e) {
    ...
    0 == b && 0 == c ? (a.style.width = d + "px",
        a.style.height = e + "px",
        a.style.overflow = "hidden") : a.style.clip = "rect(" + c + "px " +
      (b + d) + "px " + (c + e) + "px " + b + "px)"
  },
  rotate: function(a, b) {
    if (0 != Number(b)) {
      ...
      var e = b * Math.PI / 180,
        ...
        c = c.offsetHeight,
        m = b / Math.abs(b);
      d.left = h + l / 2 - l / 2 * Math.cos(e) - m * c / 2 * Math.sin(e) +
        3;
      d.top = k - m * l / 2 * Math.sin(e) + m * c / 2 * Math.sin(e);
      d.cssText = d.cssText +
        "; filter:progid:DXImageTransform.Microsoft.Matrix(M11='" + f +
        "', M12='" + -g + "', M21='" + g + "', M22='" + f +
  ...
  gradient: function(a, b, c, d) {
    ...
    a = a.fill;
    90 == d ? d = 0 : 270 == d ? d = 180 : 180 == d ? d = 90 : 0 === d &&
      (d = 270);
...
AmCharts.SVGRenderer = AmCharts.Class({
  ...
  animate: function(a, b, c, d, e) {
    var f = this,
      g = a.node;
    "translate" == b ? (g = (g = g.getAttribute("transform")) ? String(g)
      .substring(10, g.length - 1) : "0,0",
      g = g.split(", ").join(" "),
      g = g.split(" ").join(","),
      0 === g && (g = "0,0")) : g = g.getAttribute(b);
    b = {
      obj: a,
      frame: 0,
      attribute: b,
  ...
  updateAnimations: function() {
    ...
    for (a = this.animations.length - 1; 0 <= a; a--) {
      var b = this.animations[a],
        ...
        g, h, k;
      d <= c ? (b.frame++,
        "translate" == f ? (g = b.from.split(","),
          f = Number(g[0]),
          g = Number(g[1]),
          h = b.to.split(","),
          k = Number(h[0]),
          h = Number(h[1]),
          k = 0 === k - f ? k : Math.round(this.D[b.effect](0, d, f, k -
            f, c)),
          b = 0 === h - g ? h : Math.round(this.D[b.effect](0, d, g, h -
            g, c)),
          f = "transform",
          b = "translate(" + k + "," + b + ")") : (g = Number(b.from),
          k = Number(b.to),
          k -= g,
          b = this.D[b.effect](0, d, g, k, c),
          0 === k && this.animations.splice(a, 1)),
        this.setAttr(e, f, b)) : ("translate" == f ? (h = b.to.split(
            ","),
          k = Number(h[0]),
          h = Number(h[1]),
          e.translate(k, h)) : (k = Number(b.to),
          this.setAttr(e, f, k)),
        this.animations.splice(a, 1))
    }
  },
  ...
  clipRect: function(a, b, c, d, e) {
    ...
    g && this.D.remove(g);
    var h = f.parentNode;
    h && (f = document.createElementNS(AmCharts.SVG_NS, "clipPath"),
      g = AmCharts.getUniqueId(),
      f.setAttribute("id", g),
      this.D.rect(b, c, d, e, 0, 0, f),
      h.appendChild(f),
      b = "#",
      AmCharts.baseHref && !AmCharts.isIE && (b = window.location.href +
        b),
  ...
  gradient: function(a, b, c, d) {
    ...
    if (!isNaN(d)) {
      var g = 0,
        ...
        k = 0,
        l = 0;
      90 == d ? k = 100 : 270 == d ? l = 100 : 180 == d ? g = 100 : 0 ===
        d && (h = 100);
      b.setAttribute("x1", g + "%");
      b.setAttribute("x2", h + "%");
      b.setAttribute("y1", k + "%");
